package com.unlikepaladin.pfm.blocks.models.chairModern.neoforge;
...
public class NeoForgeChairModernModel extends PFMNeoForgeBakedModel {
    public NeoForgeChairModernModel(ModelState settings, ModelRenderProperties modelSettings, List<BlockModelPart> templateBakedModels) {
        super(settings, modelSettings, templateBakedModels);
    }

    @Override
    public void collectParts(BlockAndTintGetter level, BlockPos pos, BlockState state, RandomSource random, List<BlockModelPart> parts) {
        if (state == null || !(state.getBlock() instanceof ModernChairBlock))
            return;
