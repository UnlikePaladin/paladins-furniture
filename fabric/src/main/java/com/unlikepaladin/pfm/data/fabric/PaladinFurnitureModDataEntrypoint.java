    ...
    private static class PFMRecipeProvider extends FabricRecipesProvider {
        ...
        protected void generateRecipes(Consumer<RecipeJsonProvider> exporter) {
            ...
            for (FurnitureBlock kitchenCounter : woodKitchenCounters) {
                ...
                if (cabinetName.contains("light_wood")) {
                    offerCounterRecipe(kitchenCounter.getBlock(), Ingredient.ofItems(Registry.BLOCK.get(new ResourceLocation("minecraft:" + "smooth_quartz"))), Ingredient.ofItems(Registry.BLOCK.get(new ResourceLocation("minecraft:" + "stripped_oak_log"))), exporter);
                } else if (cabinetName.contains("dark_wood")) {
                    offerCounterRecipe(kitchenCounter.getBlock(), Ingredient.ofItems(Registry.BLOCK.get(new ResourceLocation("minecraft:" + "smooth_quartz"))), Ingredient.ofItems(Registry.BLOCK.get(new ResourceLocation("minecraft:" + "stripped_dark_oak_log"))), exporter);
                } else {
