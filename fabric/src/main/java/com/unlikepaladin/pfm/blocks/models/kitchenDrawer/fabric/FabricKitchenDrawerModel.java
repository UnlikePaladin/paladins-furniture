...
public class FabricKitchenDrawerModel extends PFMFabricBakedModel {
    ...
    private void middleCounter(BlockAndTintGetter world, BlockState state, BlockPos pos, Supplier<RandomSource> randomSupplier, RenderContext context, boolean left, boolean right, int openOffset) {
        if (left && right) {
