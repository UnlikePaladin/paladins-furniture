...
import com.unlikepaladin.pfm.blocks.models.modernDinnerTable.fabric.FabricModernDinnerTableModel;
...
public class UnbakedModernCoffeeTableModelImpl {
    ...
    public static BakedModel getBakedModel(ModelBakeSettings settings, List<BakedModel> modelParts) {
        ...
        BakedModel model = new FabricModernCoffeeTableModel(settings, modelParts);
