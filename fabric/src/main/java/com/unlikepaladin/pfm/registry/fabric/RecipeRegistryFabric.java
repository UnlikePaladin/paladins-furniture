...
public class RecipeRegistryFabric {
    public static void registerRecipes() {
        ...
        RecipeTypes.FURNITURE_SERIALIZER = Registry.register(Registries.RECIPE_SERIALIZER, new Identifier(PaladinFurnitureMod.MOD_ID,"furniture"), new FurnitureRecipe.Serializer());
