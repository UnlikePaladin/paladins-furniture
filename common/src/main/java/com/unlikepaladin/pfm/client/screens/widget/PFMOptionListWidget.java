...
public class PFMOptionListWidget extends ContainerObjectSelectionList<PFMOptionListWidget.Entry> {
    ...
    public class CategoryEntry
        ...
        public void render(GuiGraphics context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            context.drawString(PFMOptionListWidget.this.minecraft.font, this.text.setStyle(Style.EMPTY.withBold(true)), (PFMOptionListWidget.this.minecraft.screen.width / 2 - this.textWidth / 2), y + entryHeight - (PFMOptionListWidget.this).minecraft.font.lineHeight - 1, PFMFileUtil.adjustColor(0xFFFFFF), true);
        }
    ...
    public class BooleanEntry
        ...
        BooleanEntry(final BooleanConfigOption configOption, final Component optionName, int index) {
            ...
            this.index = index;
            final MutableComponent sideText = configOption.getSide() == Side.CLIENT ? Component.translatable("pfm.option.client").setStyle(Style.EMPTY.withItalic(false).withBold(true).withColor(PFMFileUtil.adjustColor(0xf77f34))) : Component.translatable("pfm.option.server").setStyle((Style.EMPTY.withItalic(false).withBold(true).withColor(PFMFileUtil.adjustColor(0xf77f34))));
        ...
        @Override
        public void render(GuiGraphics context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            context.drawString(PFMOptionListWidget.this.minecraft.font, this.optionName, (x + 90 - PFMOptionListWidget.this.maxKeyNameLength), (y + entryHeight / 2 - PFMOptionListWidget.this.minecraft.font.lineHeight / 2), PFMFileUtil.adjustColor(0xFFFFFF), false);
    ...
    public class DoubleEntry
        ...
        DoubleEntry(final DoubleConfigOption configOption, final Component optionName, int index) {
            ...
            this.supplier = Tooltip.create(combinedText);
            ...
            this.valueEditBox.setTooltip(supplier);
            ...
            .createNarration(textSupplier -> Component.translatable("narrator.controls.reset", optionName))
            .build();
        }
    ...
    public class ButtonEntry
        ...
        ButtonEntry(Side side, final Component optionName, Component buttonText, Component tooltip, Button.OnPress pressAction) {
            this.optionName = optionName;
            this.side = side;
            final MutableComponent sideText = side == Side.CLIENT ? Component.translatable("pfm.option.client").setStyle(Style.EMPTY.withItalic(false).withBold(true).withColor(PFMFileUtil.adjustColor(0xf77f34))) : Component.translatable("pfm.option.server").setStyle((Style.EMPTY.withItalic(false).withBold(true).withColor(PFMFileUtil.adjustColor(0xf77f34))));
