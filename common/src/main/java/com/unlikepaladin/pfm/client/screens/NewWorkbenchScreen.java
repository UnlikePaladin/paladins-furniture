...
public class NewWorkbenchScreen extends HandledScreen<NewWorkbenchScreenHandler> {
    ...
    public NewWorkbenchScreen(NewWorkbenchScreenHandler handler, PlayerInventory inventory, Text title) {
