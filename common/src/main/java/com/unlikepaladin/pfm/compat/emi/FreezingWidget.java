...
public class FreezingWidget extends EmiTexture {
    public static final ResourceLocation FREEZER_WIDGET = ResourceLocation.fromNamespaceAndPath("pfm", "textures/gui/container/freezer.png");
    ...
    public FreezingWidget(ResourceLocation texture, int u, int v, int width, int height) {
        super(texture, u, v, width, height);
    }

    public FreezingWidget(ResourceLocation texture, int u, int v, int width, int height, int regionWidth, int regionHeight, int textureWidth, int textureHeight) {
