...
public class FurnitureBlock extends PFMMaterial {
    ...
    public Item getSecondaryMaterial() {
        ...
        if(secondMaterial.contains("andesite")){
            ...
            this.secondMaterial = BuiltInRegistries.ITEM.get(new ResourceLocation("pfm:" + secondMaterial));
        ...
        this.secondMaterial = BuiltInRegistries.ITEM.get(new ResourceLocation("minecraft:" + secondMaterial));
        return this.secondMaterial;
    }
    ...
    public Item getBaseMaterial() {
        ...
        this.baseMaterial = BuiltInRegistries.ITEM.get(new ResourceLocation("minecraft:" + baseMaterial));
    ...
    public Item getFroggyChairMaterial() {
        ...
        if (baseMaterial.matches("froggy_chair")) {
            this.baseMaterial = BuiltInRegistries.ITEM.get(new ResourceLocation("minecraft:" + "lime_concrete"));
            return this.baseMaterial;
        }
    ...
    public Item getFridgeMaterial() {
        ...
        if (baseMaterial.contains("iron")) {
            this.baseMaterial =  BuiltInRegistries.ITEM.get(new ResourceLocation("minecraft:" + "iron_ingot"));
            return this.baseMaterial;
        }
        else if (baseMaterial.contains("xbox")) {
            this.baseMaterial = BuiltInRegistries.ITEM.get(new ResourceLocation("minecraft:" + "black_concrete"));
            return this.baseMaterial;
        }
    ...
    public Block getSlab(){
        ...
        this.slab =  BuiltInRegistries.BLOCK.get(new ResourceLocation(originalId.getNamespace(), slabName));
        return slab;
    }
    ...
    public Item getArmChairMaterial() {
        ...
        if (baseMaterial.contains("leather")) {
            this.baseMaterial = BuiltInRegistries.ITEM.get(new ResourceLocation("pfm:" + "leather_block"));
            return this.baseMaterial;
        }
        else if (baseMaterial.contains("standard")) {
            this.baseMaterial = BuiltInRegistries.ITEM.get(new ResourceLocation("minecraft:" + "white_wool"));
            return this.baseMaterial;
        }
        if (this.block instanceof DyeableFurnitureBlock) {
            String color = ((DyeableFurnitureBlock) this.block).getPFMColor().toString();
            this.baseMaterial = BuiltInRegistries.ITEM.get(new ResourceLocation("minecraft:" + color + "_wool"));
            return this.baseMaterial;
        }
    ...
    public Item getBaseStoneMaterial() {
        ...
        if(baseMaterial.contains("andesite")){
            ...
            this.baseMaterial = BuiltInRegistries.ITEM.get(new ResourceLocation("pfm:" + baseMaterial));
            return this.baseMaterial;
        }
        else if(baseMaterial.contains("deepslate")){
