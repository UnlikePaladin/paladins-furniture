...
public class StoneVariant extends VariantBase<StoneVariant> {
    ...
    public static StoneVariant CALCITE = new StoneVariant(Blocks.CALCITE, Blocks.STRIPPED_WARPED_STEM,"calcite");
    ...
    public static StoneVariant DEEPSLATE = new StoneVariant(Blocks.POLISHED_DEEPSLATE,  Blocks.DEEPSLATE,"deepslate");
