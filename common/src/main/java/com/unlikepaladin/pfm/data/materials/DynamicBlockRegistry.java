...
public class DynamicBlockRegistry {
    ...
    public static void compatInit() {
        ...
        addBlockTypeFinder(WoodVariant.class, WoodVariant.Finder.simple(new ResourceLocation("domum_ornamentum:cactus"),
                new ResourceLocation("domum_ornamentum:green_cactus_extra"), new ResourceLocation("cactus")));
        addBlockTypeFinder(WoodVariant.class, WoodVariant.Finder.simple(new ResourceLocation("domum_ornamentum:cactus_extra"),
