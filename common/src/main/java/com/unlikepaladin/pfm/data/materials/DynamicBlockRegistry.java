...
public class DynamicBlockRegistry {
    ...
    public static void compatInit() {
        ...
        addBlockTypeFinder(WoodVariant.class, WoodVariant.Finder.simple(Identifier.parse("domum_ornamentum:cactus"),
                Identifier.parse("domum_ornamentum:green_cactus_extra"), Identifier.parse("cactus")));
        addBlockTypeFinder(WoodVariant.class, WoodVariant.Finder.simple(Identifier.parse("domum_ornamentum:cactus_extra"),
                Identifier.parse("domum_ornamentum:cactus_extra"), Identifier.parse("cactus")));
        ...
        floweringAzalea.addChild("leaves", Identifier.parse("minecraft:flowering_azalea_leaves"));
        ...
        azalea.addChild("leaves", Identifier.parse("minecraft:azalea_leaves"));
        ...
        quarkAzalea.addChild("leaves", Identifier.parse("minecraft:azalea_leaves"));
        ...
        vanillaBamboo.addChild("stripped_log", Identifier.parse("minecraft:stripped_bamboo_block"));
