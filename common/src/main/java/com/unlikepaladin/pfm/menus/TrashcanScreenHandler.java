...
public class TrashcanScreenHandler extends AbstractContainerMenu {
    ...
    public TrashcanScreenHandler(int containerId, Inventory playerInventory, TrashCanData canData) {
        this(null, containerId, playerInventory, new SimpleContainer(9));
        trashcanBlockEntity = (TrashcanBlockEntity) level.getBlockEntity(canData.pos());
    }
