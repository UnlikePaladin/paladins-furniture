...
public class OvenScreenHandler extends RecipeBookMenu<Container> {
    ...
    public OvenScreenHandler(int containerId, Inventory inventory, FriendlyByteBuf byteBuf) {
        // client-side menu: create a PropertyDelegate sized to match the server-side layout
        this(containerId, inventory, new SimpleContainer(SLOT_COUNT), new SimpleContainerData(2 + PROCESSING_SLOT_COUNT * 2));
    ...
    public OvenScreenHandler(int containerId, Inventory inventory, Container container, ContainerData containerData) {
        super(ScreenHandlerIDs.STOVE_SCREEN_HANDLER, containerId);
