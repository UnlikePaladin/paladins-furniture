...
public class LateBlockRegistry {
    ...
    public static void registerBlocks() throws InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        PaladinFurnitureModBlocksItems.furnitureEntryMap.put(FroggyChairBlock.class, new FurnitureEntry<FroggyChairBlock>() {{
            this.addBlock(registerLateBlock("froggy_chair", () -> new FroggyChairBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.GREEN).strength(9.0f, 8.0f).nonOpaque().requiresTool()), true, PaladinFurnitureMod.FURNITURE_GROUP));
            this.addBlock(registerLateBlock("froggy_chair_pink", () -> new FroggyChairBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.PINK).strength(9.0f, 8.0f).nonOpaque().requiresTool()), true, PaladinFurnitureMod.FURNITURE_GROUP));
            this.addBlock(registerLateBlock("froggy_chair_light_blue", () -> new FroggyChairBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.LIGHT_BLUE).strength(9.0f, 8.0f).nonOpaque().requiresTool()), true, PaladinFurnitureMod.FURNITURE_GROUP));
            this.addBlock(registerLateBlock("froggy_chair_blue", () -> new FroggyChairBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.BLUE).strength(9.0f, 8.0f).nonOpaque().requiresTool()), true, PaladinFurnitureMod.FURNITURE_GROUP));
            this.addBlock(registerLateBlock("froggy_chair_orange", () -> new FroggyChairBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.ORANGE).strength(9.0f, 8.0f).nonOpaque().requiresTool()), true, PaladinFurnitureMod.FURNITURE_GROUP));
            this.addBlock(registerLateBlock("froggy_chair_yellow", () -> new FroggyChairBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.YELLOW).strength(9.0f, 8.0f).nonOpaque().requiresTool()), true, PaladinFurnitureMod.FURNITURE_GROUP));
        }});
        PaladinFurnitureModBlocksItems.furnitureEntryMap.put(SimpleSofaBlock.class, new FurnitureEntry<SimpleSofaBlock>() {{
            for (DyeColor color : DyeColor.values()) {
                this.addBlock(registerLateBlock(color.getName() + "_simple_sofa", () -> new SimpleSofaBlock(color, AbstractBlock.Settings.of(Material.WOOL, color.getMapColor()).strength(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL)), true, PaladinFurnitureMod.FURNITURE_GROUP));
            }}});
        PaladinFurnitureModBlocksItems.furnitureEntryMap.put(ArmChairBlock.class, new FurnitureEntry<ArmChairBlock>() {{
            this.addBlock(registerLateBlock("arm_chair_leather", () -> new ArmChairBlock(AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT).strength(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL)), true, PaladinFurnitureMod.FURNITURE_GROUP));
        }});
        PaladinFurnitureModBlocksItems.furnitureEntryMap.put(ArmChairColoredBlock.class, new FurnitureEntry<ArmChairColoredBlock>() {{
            for (DyeColor color : DyeColor.values()) {
                this.addBlock(registerLateBlock(color.getName() + "_arm_chair", () -> new ArmChairColoredBlock(color, AbstractBlock.Settings.of(Material.WOOL, color.getMapColor()).strength(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL)), true, PaladinFurnitureMod.FURNITURE_GROUP));
            }
        }});
        ...
        PaladinFurnitureModBlocksItems.furnitureEntryMap.put(KitchenCounterBlock.class, new FurnitureEntry<KitchenCounterBlock>() {{
            for (WoodVariant variant : WoodVariantRegistry.getVariants()) {
                ...
                PaladinFurnitureModBlocksItems.furnitureEntryMap.get(KitchenSinkBlock.class).addBlock(variant, LateBlockRegistry.registerLateBlock(variant.asString()+"_kitchen_sink", () -> new KitchenSinkBlock(AbstractBlock.Settings.copy(variant.getBaseBlock()).nonOpaque(), SinkBehavior.WATER_SINK_BEHAVIOR), true, PaladinFurnitureMod.FURNITURE_GROUP), true);
        ...
        PaladinFurnitureModBlocksItems.furnitureEntryMap.put(ShowerTowelBlock.class, new FurnitureEntry<ShowerTowelBlock>() {{
            for (DyeColor color : DyeColor.values()) {
                this.addBlock(registerLateBlock(color.getName() + "_shower_towel", () -> new ShowerTowelBlock(color, AbstractBlock.Settings.of(Material.WOOL, color.getMapColor()).strength(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL)), true, PaladinFurnitureMod.FURNITURE_GROUP));
            }
        }});
