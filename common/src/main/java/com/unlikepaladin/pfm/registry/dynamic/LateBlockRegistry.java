    ...
    public static void registerBlocks() throws InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        PaladinFurnitureModBlocksItems.furnitureEntryMap.put(HerringbonePlankBlock.class, new FurnitureEntry<>() {{
            for (WoodVariant variant : WoodVariantRegistry.getVariants()) {
                ...
                this.addBlock(variant, LateBlockRegistry.registerLateBlock(variant.getSerializedName()+"_herringbone_planks", () -> new HerringbonePlankBlock(BlockBehaviour.Properties.copy(variant.getBaseBlock()).sound(SoundType.WOOD).color(color).noOcclusion()), true, CreativeModeTab.TAB_BUILDING_BLOCKS), true);
            }
        }});
        ...
        PaladinFurnitureModBlocksItems.furnitureEntryMap.put(ClassicChairDyeableBlock.class, new FurnitureEntry<>() {{
            ...
            for (DyeColor color : DyeColor.values()) {
                if (i > 15)
                    break;
                this.addBlock(registerLateBlock("oak_chair_classic_" + color.getName(), () -> new ClassicChairDyeableBlock(color, BlockBehaviour.Properties.copy(PaladinFurnitureModBlocksItems.furnitureEntryMap.get(BasicChairBlock.class).allBlocks.get(0))), true, PaladinFurnitureMod.FURNITURE_GROUP));
                i++;
            }
        }});
        ...
        PaladinFurnitureModBlocksItems.furnitureEntryMap.put(SimpleBedBlock.class, new FurnitureEntry<>() {{
            for (WoodVariant variant : WoodVariantRegistry.getVariants()) {
                ...
                for (DyeColor color : DyeColor.values()) {
                    ...
                    SimpleBedBlock block = LateBlockRegistry.registerLateBlock(blockName, () -> new SimpleBedBlock(color, BlockBehaviour.Properties.of(Material.WOOL, state -> state.getValue(BedBlock.PART) == BedPart.FOOT ? color.getMaterialColor() : MaterialColor.WOOL).sound(SoundType.WOOD).strength(0.2f).noOcclusion()), false, PaladinFurnitureMod.FURNITURE_GROUP);
                    LateBlockRegistry.registerLateItem(blockName, () -> BedBlockItem.getItemFactory(block, new BlockItem.Properties().stacksTo(1).tab(PaladinFurnitureMod.FURNITURE_GROUP)));
        ...
        PaladinFurnitureModBlocksItems.furnitureEntryMap.put(ClassicBedBlock.class, new FurnitureEntry<>() {{
            for (WoodVariant variant : WoodVariantRegistry.getVariants()) {
                ...
                for (DyeColor color : DyeColor.values()) {
                    ...
                    ClassicBedBlock block = LateBlockRegistry.registerLateBlock(blockName, () -> new ClassicBedBlock(color, BlockBehaviour.Properties.of(Material.WOOL, state -> state.getValue(BedBlock.PART) == BedPart.FOOT ? color.getMaterialColor() : MaterialColor.WOOL).sound(SoundType.WOOD).strength(0.2f).noOcclusion()), false, PaladinFurnitureMod.FURNITURE_GROUP);
                    LateBlockRegistry.registerLateItem(blockName, () -> BedBlockItem.getItemFactory(block, new BlockItem.Properties().stacksTo(1).tab(PaladinFurnitureMod.FURNITURE_GROUP)));
                    this.addBlock(variant, block, true);
                    PaladinFurnitureModBlocksItems.beds.add(block);
                    i++;
        ...
        PaladinFurnitureModBlocksItems.furnitureEntryMap.put(KitchenCounterBlock.class, new FurnitureEntry<>() {{
            for (WoodVariant variant : WoodVariantRegistry.getVariants()) {
                ...
                PaladinFurnitureModBlocksItems.furnitureEntryMap.get(KitchenDrawerBlock.class).addBlock(variant, LateBlockRegistry.registerLateBlock(variant.getSerializedName()+"_kitchen_drawer", () -> new KitchenDrawerBlock(BlockBehaviour.Properties.copy(variant.getBaseBlock()).color(color).noOcclusion()), true, PaladinFurnitureMod.FURNITURE_GROUP), true);
                PaladinFurnitureModBlocksItems.furnitureEntryMap.get(KitchenCabinetBlock.class).addBlock(variant, LateBlockRegistry.registerLateBlock(variant.getSerializedName()+"_kitchen_cabinet", () -> new KitchenCabinetBlock(BlockBehaviour.Properties.copy(variant.getBaseBlock()).color(color).noOcclusion()), true, PaladinFurnitureMod.FURNITURE_GROUP), true);
                PaladinFurnitureModBlocksItems.furnitureEntryMap.get(KitchenSinkBlock.class).addBlock(variant, LateBlockRegistry.registerLateBlock(variant.getSerializedName()+"_kitchen_sink", () -> new KitchenSinkBlock(BlockBehaviour.Properties.copy(variant.getBaseBlock()).color(color).noOcclusion(), LayeredCauldronBlock.RAIN, SinkBehavior.WATER_SINK_BEHAVIOR), true, PaladinFurnitureMod.FURNITURE_GROUP), true);
                ...
                PaladinFurnitureModBlocksItems.furnitureEntryMap.get(KitchenWallDrawerBlock.class).addBlock(variant, LateBlockRegistry.registerLateBlock(variant.getSerializedName()+"_kitchen_wall_drawer", () -> new KitchenWallDrawerBlock(BlockBehaviour.Properties.copy(variant.getBaseBlock()).color(color).noOcclusion()), true, PaladinFurnitureMod.FURNITURE_GROUP), true);
                PaladinFurnitureModBlocksItems.furnitureEntryMap.get(KitchenWallDrawerSmallBlock.class).addBlock(variant, LateBlockRegistry.registerLateBlock(variant.getSerializedName()+"_kitchen_wall_small_drawer", () -> new KitchenWallDrawerSmallBlock(BlockBehaviour.Properties.copy(variant.getBaseBlock()).color(color).noOcclusion()), true, PaladinFurnitureMod.FURNITURE_GROUP), true);
                if (variant.hasStripped()) {
