...
public class NetworkIDs {
    ...
    public static final CustomPacketPayload.Type<SyncRecipesPayload> SYNC_FURNITURE_RECIPES = new CustomPacketPayload.Type<>(ResourceLocation.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "sync_furniture_recipes"));
