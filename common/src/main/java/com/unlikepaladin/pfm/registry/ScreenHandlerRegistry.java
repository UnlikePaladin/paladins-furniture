...
public class ScreenHandlerRegistry {
    public static void registerScreenHandlers() {
        ...
        ScreenHandlerIDs.IRON_STOVE_SCREEN_HANDLER = registerScreenHandlerSimple(ResourceLocation.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID,"iron_stove_block_entity"), IronStoveScreenHandler::new);
