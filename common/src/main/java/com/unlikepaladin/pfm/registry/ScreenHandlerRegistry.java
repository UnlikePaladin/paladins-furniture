...
public class ScreenHandlerRegistry {
    public static void registerScreenHandlers() {
        ...
        ScreenHandlerIDs.OVEN_SCREEN_HANDLER = registerScreenHandlerExtended(ResourceLocation.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID,"oven_block_entity"),
                ((integer, inventory, byteBuf) -> new OvenScreenHandler(ScreenHandlerIDs.OVEN_SCREEN_HANDLER, integer, inventory, byteBuf)), StoveData.PACKET_CODEC
        );
