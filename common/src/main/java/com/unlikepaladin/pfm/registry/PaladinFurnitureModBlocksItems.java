...
public class PaladinFurnitureModBlocksItems {
    ...
    public static final Block WHITE_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.WHITE, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block BLUE_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.BLUE, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block GREEN_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.GREEN, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block GRAY_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.GRAY, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block PINK_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.PINK, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block BROWN_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.BROWN, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block ORANGE_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.ORANGE, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block YELLOW_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.YELLOW, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block PURPLE_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.PURPLE, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block CYAN_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.CYAN, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block LIME_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.LIME, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block MAGENTA_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.MAGENTA, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block LIGHT_BLUE_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.LIGHT_BLUE, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block LIGHT_GRAY_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.LIGHT_GRAY, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block RED_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.RED, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block BLACK_SHOWER_TOWEL = new ShowerTowelBlock(DyeColor.BLACK, AbstractBlock.Settings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
