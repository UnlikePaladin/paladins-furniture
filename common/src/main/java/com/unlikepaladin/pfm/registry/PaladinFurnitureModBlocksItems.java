...
public class PaladinFurnitureModBlocksItems {
    ...
    public static final FreezerBlock WHITE_FREEZER = new FreezerBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.WHITE).strength(5.0f, 3.5f).sounds(BlockSoundGroup.STONE), () -> PaladinFurnitureModBlocksItems.WHITE_FRIDGE);
    ...
    public static final FreezerBlock GRAY_FREEZER = new FreezerBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.GRAY).strength(5.0f,3.5f).sounds(BlockSoundGroup.STONE), () -> PaladinFurnitureModBlocksItems.GRAY_FRIDGE);
    ...
    public static final FreezerBlock IRON_FREEZER = new IronFreezerBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.IRON_GRAY).strength(5.0f,3.5f).sounds(BlockSoundGroup.METAL), () -> PaladinFurnitureModBlocksItems.IRON_FRIDGE);
    ...
    public static final FridgeBlock XBOX_FRIDGE = new XboxFridgeBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.BLACK).strength(5.0f, 3.5f).sounds(BlockSoundGroup.STONE).nonOpaque(), null);
    ...
    public static final PendantBlock GRAY_MODERN_PENDANT = new PendantBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.GRAY).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.STONE).nonOpaque().luminance(createLightLevelFromLitBlockState(15)));
    public static final PendantBlock WHITE_MODERN_PENDANT = new PendantBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.WHITE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.STONE).nonOpaque().luminance(createLightLevelFromLitBlockState(15)));
    public static final PendantBlock GLASS_MODERN_PENDANT = new PendantBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.OFF_WHITE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.STONE).nonOpaque().luminance(createLightLevelFromLitBlockState(15)));
    public static final SimpleLightBlock SIMPLE_LIGHT = new SimpleLightBlock(AbstractBlock.Settings.of(Material.METAL, MapColor.LIGHT_GRAY).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.STONE).nonOpaque().luminance(createLightLevelFromLitBlockState(15)));

    public static final LightSwitchBlock LIGHT_SWITCH = new LightSwitchBlock(AbstractBlock.Settings.copy(Blocks.WHITE_CONCRETE).sounds(BlockSoundGroup.STONE).nonOpaque());
    ...
    public static final BasicBathtubBlock BASIC_BATHTUB = new BasicBathtubBlock(AbstractBlock.Settings.copy(Blocks.SMOOTH_QUARTZ).nonOpaque(), BathtubBehavior.TUB_BEHAVIOR);
    ...
    public static final BasicSinkBlock BASIC_SINK = new BasicSinkBlock(AbstractBlock.Settings.copy(Blocks.SMOOTH_QUARTZ).nonOpaque(), SinkBehavior.WATER_SINK_BEHAVIOR);
