...
public interface FurnitureRecipe extends Recipe<Inventory> {
    ...
    default List<CraftableFurnitureRecipe> getAvailableOutputs(Inventory inventory, HolderLookup.Provider registryManager) {
    ...
    interface CraftableFurnitureRecipe extends Comparable<CraftableFurnitureRecipe> {
        ...
        ItemStack assemble(Inventory inventory, HolderLookup.Provider registryManager);
        ...
        default ItemStack craftAndRemoveItems(Inventory playerInventory, HolderLookup.Provider registryManager) {
