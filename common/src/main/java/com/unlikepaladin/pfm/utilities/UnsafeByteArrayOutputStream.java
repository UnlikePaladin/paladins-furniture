...
// This was taken from ARRP, which is licensed under MPL 2.0
// https://github.com/Ueaj-Kerman/ARRP/blob/master/src/main/java/net/devtech/arrp/util/UnsafeByteArrayOutputStream.java#L8

// It's a single threaded and unsafe version of ByteArrayOutputStream for better performance
// since we don't need thread safety and we don't need to use the synchronized methods and it also grows memory more slowly
