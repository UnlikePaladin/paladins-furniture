                        ...
                        LootPool.lootPool()
                                ...
                                .add(
                                        LootItem.lootTableItem(drop)
                                                .apply(CopyCustomDataFunction.copyData(ContextNbtProvider.BLOCK_ENTITY).copy("variant", "BlockEntityTag.variant").copy("color", "BlockEntityTag.color"))
                                )
                );
    }
    ...
    static class PFMLootTableGenerator implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
        ...
        public void accept(BiConsumer<ResourceLocation, LootTable.Builder> biConsumer) {
            ...
            for (Block block : pfmBlocks) {
                ResourceLocation identifier = block.getLootTable().location();
                if (identifier == BuiltInLootTables.EMPTY.location() || !set.add(identifier)) continue;
        ...
        public final void addDrop(Block block, LootTable.Builder lootTable) {
            this.lootTables.put(block.getLootTable().location(), lootTable);
