...
public class PFMBlockstateModelProvider extends PFMProvider {
    ...
    static class PFMBlockStateModelGenerator {
        ...
        public void registerTuckableChairs() {
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(BasicChairBlock.class).getVariantToBlockMap(), "chair", TEMPLATE_CHAIR, PFMBlockStateModelGenerator::createOrientableTuckableBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(BasicChairBlock.class).getVariantToBlockMapNonBase(), "chair", TEMPLATE_CHAIR, PFMBlockStateModelGenerator::createOrientableTuckableBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(DinnerChairBlock.class).getVariantToBlockMap(), "chair_dinner", TEMPLATE_CHAIR_DINNER, PFMBlockStateModelGenerator::createOrientableTuckableBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(DinnerChairBlock.class).getVariantToBlockMapNonBase(), "chair_dinner", TEMPLATE_CHAIR_DINNER, PFMBlockStateModelGenerator::createOrientableTuckableBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ClassicChairBlock.class).getVariantToBlockMap(), "chair_classic", TEMPLATE_CHAIR_CLASSIC, PFMBlockStateModelGenerator::createOrientableTuckableBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ClassicChairBlock.class).getVariantToBlockMapNonBase(), "chair_classic", TEMPLATE_CHAIR_CLASSIC, PFMBlockStateModelGenerator::createOrientableTuckableBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ModernChairBlock.class).getVariantToBlockMap(), "chair_modern", TEMPLATE_CHAIR_MODERN, PFMBlockStateModelGenerator::createOrientableTuckableBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ModernChairBlock.class).getVariantToBlockMapNonBase(), "chair_modern", TEMPLATE_CHAIR_MODERN, PFMBlockStateModelGenerator::createOrientableTuckableBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(LogStoolBlock.class).getVariantToBlockMap(), "log_stool", TEMPLATE_LOG_STOOL, (block, identifiers) -> createOrientableTuckableBlockState(block, identifiers, 90), PFMBlockStateModelGenerator::createLogLogTopBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(SimpleStoolBlock.class).getVariantToBlockMap(), "simple_stool", TEMPLATE_SIMPLE_STOOL, (block, identifiers) -> createOrientableTuckableBlockState(block, identifiers, 90), PFMBlockStateModelGenerator::createPlankLogBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(SimpleStoolBlock.class).getVariantToBlockMapNonBase(), "simple_stool", TEMPLATE_SIMPLE_STOOL, (block, identifiers) -> createOrientableTuckableBlockState(block, identifiers, 90), PFMBlockStateModelGenerator::createPlankLogBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ClassicStoolBlock.class).getVariantToBlockMap(), "classic_stool", TEMPLATE_CLASSIC_STOOL, (block, identifiers) -> createOrientableTuckableBlockState(block, identifiers, 90), PFMBlockStateModelGenerator::createPlankLogBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ClassicStoolBlock.class).getVariantToBlockMapNonBase(), "classic_stool", TEMPLATE_CLASSIC_STOOL, (block, identifiers) -> createOrientableTuckableBlockState(block, identifiers, 90), PFMBlockStateModelGenerator::createPlankLogBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ModernStoolBlock.class).getVariantToBlockMap(), "modern_stool", TEMPLATE_MODERN_STOOL, (block, identifiers) -> createOrientableTuckableBlockState(block, identifiers, 90), PFMBlockStateModelGenerator::createPlankLogBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ModernStoolBlock.class).getVariantToBlockMapNonBase(), "modern_stool", TEMPLATE_MODERN_STOOL, (block, identifiers) -> createOrientableTuckableBlockState(block, identifiers, 90), PFMBlockStateModelGenerator::createPlankLogBlockTexture);
        }

        public void registerTables() {
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(BasicTableBlock.class).getVariantToBlockMap(), "table_basic", TEMPLATE_BASIC_TABLE_ARRAY, PFMBlockStateModelGenerator::createAxisOrientableTableBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(BasicTableBlock.class).getVariantToBlockMapNonBase(), "table_basic", TEMPLATE_BASIC_TABLE_ARRAY, PFMBlockStateModelGenerator::createAxisOrientableTableBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ClassicTableBlock.class).getVariantToBlockMap(), "table_classic", TEMPLATE_CLASSIC_TABLE_ARRAY, PFMBlockStateModelGenerator::createSingleStateBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ClassicTableBlock.class).getVariantToBlockMapNonBase(), "table_classic", TEMPLATE_CLASSIC_TABLE_ARRAY, PFMBlockStateModelGenerator::createSingleStateBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(LogTableBlock.class).getVariantToBlockMap(), "log_table", TEMPLATE_LOG_TABLE_ARRAY, PFMBlockStateModelGenerator::createOrientableTableBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(LogTableBlock.class).getVariantToBlockMapNonBase(), "log_table", TEMPLATE_LOG_TABLE_ARRAY, PFMBlockStateModelGenerator::createOrientableTableBlockState, PFMBlockStateModelGenerator::createPlankLogBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(RawLogTableBlock.class).getVariantToBlockMap(), "log_table", TEMPLATE_LOG_TABLE_ARRAY, PFMBlockStateModelGenerator::createOrientableTableBlockState, PFMBlockStateModelGenerator::createRawBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(RawLogTableBlock.class).getVariantToBlockMapNonBase(), "log_table", TEMPLATE_LOG_TABLE_ARRAY, PFMBlockStateModelGenerator::createOrientableTableBlockState, PFMBlockStateModelGenerator::createRawBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(DinnerTableBlock.class).getVariantToBlockMap(), "dinner_table", TEMPLATE_DINNER_TABLE_ARRAY, (block, identifiers) -> createOrientableTableBlockState(block, identifiers, 90), PFMBlockStateModelGenerator::createPlankLogBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(DinnerTableBlock.class).getVariantToBlockMapNonBase(), "dinner_table", TEMPLATE_DINNER_TABLE_ARRAY, (block, identifiers) -> createOrientableTableBlockState(block, identifiers, 90), PFMBlockStateModelGenerator::createPlankLogBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ModernDinnerTableBlock.class).getVariantToBlockMap(), "table_modern_dinner", TEMPLATE_MODERN_DINNER_TABLE_ARRAY, (block, identifiers) -> createAxisOrientableTableBlockState(block, identifiers, 90), PFMBlockStateModelGenerator::createPlankLogBlockTexture);
        ...
        public void registerNightStands() {
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ClassicNightstandBlock.class).getVariantToBlockMap(), "classic_nightstand", TEMPLATE_CLASSIC_NIGHTSTAND_ARRAY, (block, identifiers) -> createOrientableTableBlockState(block, identifiers, 90), PFMBlockStateModelGenerator::createPlankLogBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(ClassicNightstandBlock.class).getVariantToBlockMapNonBase(), "classic_nightstand", TEMPLATE_CLASSIC_NIGHTSTAND_ARRAY, (block, identifiers) -> createOrientableTableBlockState(block, identifiers, 90), PFMBlockStateModelGenerator::createPlankLogBlockTexture);
        }

        public void registerBeds() {
            generateModelAndBlockStateForBed(PaladinFurnitureMod.furnitureEntryMap.get(SimpleBedBlock.class).getVariantToBlockMapList(), "simple_bed", TEMPLATE_SIMPLE_BED_ARRAY, PFMBlockStateModelGenerator::createBedBlockState, PFMBlockStateModelGenerator::createPlankBlockTexture);
            generateModelAndBlockStateForBed(PaladinFurnitureMod.furnitureEntryMap.get(ClassicBedBlock.class).getVariantToBlockMapList(), "classic_bed", TEMPLATE_CLASSIC_BED_ARRAY, PFMBlockStateModelGenerator::createBedBlockState, PFMBlockStateModelGenerator::createPlankBlockTexture);
        }
        ...
        public void registerCounters() {
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(KitchenCounterBlock.class).getVariantToBlockMap(), "kitchen_counter", TEMPLATE_KITCHEN_COUNTER, PFMBlockStateModelGenerator::createOrientableKitchenCounter, PFMBlockStateModelGenerator::createCounterBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(KitchenCounterBlock.class).getVariantToBlockMapNonBase(), "kitchen_counter", TEMPLATE_KITCHEN_COUNTER, PFMBlockStateModelGenerator::createOrientableKitchenCounter, PFMBlockStateModelGenerator::createCounterBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(KitchenDrawerBlock.class).getVariantToBlockMap(), "kitchen_drawer", TEMPLATE_KITCHEN_DRAWER, PFMBlockStateModelGenerator::createOrientableKitchenCounter, PFMBlockStateModelGenerator::createCounterBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(KitchenDrawerBlock.class).getVariantToBlockMapNonBase(), "kitchen_drawer", TEMPLATE_KITCHEN_DRAWER, PFMBlockStateModelGenerator::createOrientableKitchenCounter, PFMBlockStateModelGenerator::createCounterBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(KitchenCabinetBlock.class).getVariantToBlockMap(), "kitchen_cabinet", TEMPLATE_KITCHEN_CABINET, PFMBlockStateModelGenerator::createOrientableKitchenCounter, PFMBlockStateModelGenerator::createCounterBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(KitchenCabinetBlock.class).getVariantToBlockMapNonBase(), "kitchen_cabinet", TEMPLATE_KITCHEN_CABINET, PFMBlockStateModelGenerator::createOrientableKitchenCounter, PFMBlockStateModelGenerator::createCounterBlockTexture);

            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(KitchenWallDrawerBlock.class).getVariantToBlockMap(), "kitchen_drawer", TEMPLATE_KITCHEN_WALL_DRAWER, (block, identifiers) -> createOrientableKitchenCounter(block, identifiers, "_middle", "kitchen_drawer", "kitchen_wall_drawer", 0), PFMBlockStateModelGenerator::createCounterBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(KitchenWallDrawerBlock.class).getVariantToBlockMapNonBase(), "kitchen_drawer", TEMPLATE_KITCHEN_WALL_DRAWER, (block, identifiers) -> createOrientableKitchenCounter(block, identifiers, "_middle", "kitchen_drawer", "kitchen_wall_drawer", 0), PFMBlockStateModelGenerator::createCounterBlockTexture);
            ...
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(KitchenWallDrawerSmallBlock.class).getVariantToBlockMap(), "kitchen_wall_drawer_small", TEMPLATE_KITCHEN_WALL_DRAWER_SMALL, (block, identifiers) -> createSmallKitchenDrawer(block, identifiers, "", "", ""), PFMBlockStateModelGenerator::createCounterBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(KitchenWallDrawerSmallBlock.class).getVariantToBlockMapNonBase(), "kitchen_wall_drawer_small", TEMPLATE_KITCHEN_WALL_DRAWER_SMALL, (block, identifiers) -> createSmallKitchenDrawer(block, identifiers, "", "", ""), PFMBlockStateModelGenerator::createCounterBlockTexture);
            ...
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(KitchenSinkBlock.class).getVariantToBlockMap(), "kitchen_sink", TEMPLATE_KITCHEN_SINK, PFMBlockStateModelGenerator::createKitchenSink, PFMBlockStateModelGenerator::createCounterBlockTexture);
            generateModelAndBlockStateForVariants(PaladinFurnitureMod.furnitureEntryMap.get(KitchenSinkBlock.class).getVariantToBlockMapNonBase(), "kitchen_sink", TEMPLATE_KITCHEN_SINK, PFMBlockStateModelGenerator::createKitchenSink, PFMBlockStateModelGenerator::createCounterBlockTexture);
        }

        public void registerLamp() {
            Identifier modelID = ModelIds.getBlockModelId(PaladinFurnitureModBlocksItems.BASIC_LAMP);
            for (WoodVariant variant : WoodVariantRegistry.getVariants()) {
                TextureMap blockTexture = createRawBlockTexture(true, variant);
