...
public class PFMRuntimeResources {
    ...
    public static final FolderPackResources ASSETS_PACK = new FolderPackResources("pfm_assets_resources", getAssetPackDirectory(), true);
    public static final FolderPackResources DATA_PACK = new FolderPackResources("pfm_data_resources", getDataPackDirectory(), true);
