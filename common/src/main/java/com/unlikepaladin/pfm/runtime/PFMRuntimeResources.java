...
public class PFMRuntimeResources {
    ...
    public static final PathPackResources ASSETS_PACK = new PathPackResources("pfm_assets_resources", getAssetPackDirectory(), true);
    public static final PathPackResources DATA_PACK = new PathPackResources("pfm_data_resources", getDataPackDirectory(), true);
