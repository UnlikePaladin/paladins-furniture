...
public class PFMRuntimeResources {
    ...
    private static DirectoryResourcePack ASSETS_PACK = null;
    public static DirectoryResourcePack getAssetsPack(ResourcePackInfo info) {
        if (ASSETS_PACK == null) {
            ASSETS_PACK = new DirectoryResourcePack(info, getAssetPackDirectory());
        }
        return ASSETS_PACK;
    }
    private static DirectoryResourcePack DATA_PACK;

    public static DirectoryResourcePack getDataPack(ResourcePackInfo info) {
        if (DATA_PACK == null) {
            DATA_PACK = new DirectoryResourcePack(info, getDataPackDirectory());
        }
        return DATA_PACK;
    }
