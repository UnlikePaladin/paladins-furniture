...
public class PFMRuntimeResources {
    ...
    public static final FolderPackResources ASSETS_PACK = new FolderPackResources(getAssetPackDirectory().toFile());
    public static final FolderPackResources DATA_PACK = new FolderPackResources(getDataPackDirectory().toFile());
