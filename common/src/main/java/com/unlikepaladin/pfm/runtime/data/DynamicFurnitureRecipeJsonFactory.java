...
public class DynamicFurnitureRecipeJsonFactory {
    ...
    public static class DynamicFurnitureRecipeJsonProvider
        ...
        public DynamicFurnitureRecipeJsonProvider(ResourceLocation recipeId, String outputClass, @Nullable Tag nbtElement, int outputCount, String group, List<Ingredient> vanillaIngredients, List<ResourceLocation> supportedVariants, Map<String, Integer> variantChildren, AdvancementHolder advancement) {
