...
public class UnbakedModernStoolModel implements UnbakedModel {
    public static final ResourceLocation[] MODERN_STOOL_PARTS_BASE = new ResourceLocation[] {
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/modern_stool/modern_stool"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/modern_stool/modern_stool_tucked")
    };

    public static final ResourceLocation STOOL_MODEL_ID = new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/modern_stool");
    public static final List<ResourceLocation> MODERN_STOOL_MODEL_IDS = new ArrayList<ResourceLocation>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){
                add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/" + variant.getSerializedName() + "_modern_stool"));
                if (variant.hasStripped())
                    add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.getSerializedName() + "_modern_stool"));
            }
