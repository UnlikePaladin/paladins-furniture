...
public record UnbakedModernCoffeeTableModel(ModelVariant variant) implements PFMUnbakedBlockStateModel {
    public static final MapCodec<UnbakedModernCoffeeTableModel> MAP_CODEC = RecordCodecBuilder.mapCodec
            (instance ->
                    instance.group(ModelVariant.MAP_CODEC.forGetter(UnbakedModernCoffeeTableModel::variant))
    ...
    public static final Identifier[] MODERN_COFFEE_MODEL_PARTS_BASE = new Identifier[] {
            Identifier.of(PaladinFurnitureMod.MOD_ID, "block/coffee_table_modern/coffee_table_modern_base"),
            Identifier.of(PaladinFurnitureMod.MOD_ID, "block/coffee_table_modern/coffee_table_modern_right"),
            Identifier.of(PaladinFurnitureMod.MOD_ID, "block/coffee_table_modern/coffee_table_modern_left"),
            Identifier.of(PaladinFurnitureMod.MOD_ID, "block/coffee_table_modern/coffee_table_modern_legs"),
            Identifier.of(PaladinFurnitureMod.MOD_ID, "block/coffee_table_modern/coffee_table_modern_middle"),
    };


    public static final Identifier TABLE_MODEL_ID = Identifier.of(PaladinFurnitureMod.MOD_ID, "block/coffee_table_modern");
    public static final List<Identifier> TABLE_MODEL_IDS = new ArrayList<>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){
                add(Identifier.of(PaladinFurnitureMod.MOD_ID, "item/" + variant.asString() + "_coffee_table_modern"));
                if (variant.hasStripped())
                    add(Identifier.of(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.asString() + "_coffee_table_modern"));
            }
    ...
    public BlockStateModel bake(Baker baker){
        ...
        ModelSettings itemSettings = ModelSettings.resolveSettings(baker, baker.getModel(MODERN_COFFEE_MODEL_PARTS_BASE[0]), baker.getModel(MODERN_COFFEE_MODEL_PARTS_BASE[0]).getTextures());
