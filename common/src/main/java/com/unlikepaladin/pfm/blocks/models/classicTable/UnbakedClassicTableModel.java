...
public record UnbakedClassicTableModel(Variant variant) implements PFMUnbakedBlockStateModel {
    ...
    public static final Identifier[] CLASSIC_MODEL_PARTS_BASE = new Identifier[] {
            Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/table_classic/table_classic_middle"),
            Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/table_classic/table_classic_two"),
            Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/table_classic/table_classic_two_uved"),
            Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/table_classic/table_classic_one"),
            Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/table_classic/table_classic_one_uved"),
            Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/table_classic/table_classic")
    };

    public static final Identifier TABLE_MODEL_ID = Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/table_classic");
    public static final List<Identifier> MODEL_IDS = new ArrayList<>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){
                add(Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "item/" + variant.getSerializedName() + "_table_classic"));
                if (variant.hasStripped())
                    add(Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.getSerializedName() + "_table_classic"));
            }
