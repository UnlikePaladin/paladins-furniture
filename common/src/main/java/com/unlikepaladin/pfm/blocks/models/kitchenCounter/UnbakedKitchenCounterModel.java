...
public class UnbakedKitchenCounterModel implements UnbakedModel {
    public static final ResourceLocation[] COUNTER_MODEL_PARTS_BASE = new ResourceLocation[] {
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_counter/kitchen_counter"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_counter/kitchen_counter_edge_left"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_counter/kitchen_counter_edge_right"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_counter/kitchen_counter_inner_corner_left"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_counter/kitchen_counter_inner_corner_right"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_counter/kitchen_counter_outer_corner_left"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_counter/kitchen_counter_outer_corner_right")
    };


    private static final ResourceLocation PARENT = new ResourceLocation("block/block");
    public static final ResourceLocation COUNTER_MODEL_ID = new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_counter");
    public static final List<ResourceLocation> COUNTER_MODEL_IDS = new ArrayList<ResourceLocation>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){
                add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/" + variant.getSerializedName() + "_kitchen_counter"));
                if (variant.hasStripped())
                    add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.getSerializedName() + "_kitchen_counter"));
            }
