...
public class ClassicStoolBlock extends BasicChairBlock {
    ...
    protected static final VoxelShape CLASSIC_STOOL = PFMShapeUtil.rotateShape(Direction.NORTH, Direction.SOUTH, CLASSIC_STOOL_SOUTH);
    protected static final VoxelShape CLASSIC_STOOL_EAST = PFMShapeUtil.rotateShape(Direction.NORTH, Direction.WEST, CLASSIC_STOOL_SOUTH);
    protected static final VoxelShape CLASSIC_STOOL_WEST = PFMShapeUtil.rotateShape(Direction.NORTH, Direction.EAST, CLASSIC_STOOL_SOUTH);
    protected static final VoxelShape FACE_SOUTH_TUCKED = PFMShapeUtil.tuckShape(Direction.SOUTH, CLASSIC_STOOL_SOUTH);
    protected static final VoxelShape FACE_NORTH_TUCKED = PFMShapeUtil.tuckShape(Direction.NORTH, CLASSIC_STOOL);
    protected static final VoxelShape FACE_WEST_TUCKED = PFMShapeUtil.tuckShape(Direction.WEST, CLASSIC_STOOL_WEST);
    protected static final VoxelShape FACE_EAST_TUCKED = PFMShapeUtil.tuckShape(Direction.EAST, CLASSIC_STOOL_EAST);
