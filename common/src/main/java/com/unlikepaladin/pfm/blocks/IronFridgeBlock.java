...
public class IronFridgeBlock extends FridgeBlock {
    ...
    protected static final Map<Direction, VoxelShape> FRIDGE_SINGLE = new HashMap<Direction, VoxelShape>(){{put(Direction.NORTH, Shapes.or(box(12, 2, -0.5,13, 15, 1),box(1, 1, 1,15, 16, 2),box(1, 0, 2,15, 16, 16)));}};
    ...
    protected static final Map<Direction, VoxelShape> FRIDGE_BOTTOM = new HashMap<Direction, VoxelShape>(){{put(Direction.NORTH, Shapes.or(box(12, 2, -0.5,13, 16, 1),box(1, 1, 1,15, 16, 2),box(1, 0, 2,15, 16, 16)));}};
    protected static final Map<Direction, VoxelShape> FRIDGE = new HashMap<Direction, VoxelShape>(){{put(Direction.NORTH, Shapes.or(box(12, 1, -0.5, 13, 15, 1), box(1, 0, 1,15, 16, 2),box(1, -16, 2,15, 16, 16)));}};

    protected static final Map<Direction, VoxelShape> FRIDGE_SINGLE_OPEN = new HashMap<Direction, VoxelShape>(){{put(Direction.NORTH, Shapes.or(box(-0.5, 2, -10,1, 15, -9),box(1, 1, -12,3, 16, 3),box(1, 1, 3,15, 16, 16),box(1, 0, 2,15, 1, 16)));}};
    protected static final Map<Direction, VoxelShape> FRIDGE_TOP_OPEN = new HashMap<Direction, VoxelShape>(){{put(Direction.NORTH, Shapes.or(box(-0.5, 0, -10,1, 15, -9),box(1, 0, -12,3, 16, 3),box(1, 0, 3,15, 16, 16)));}};
    protected static final Map<Direction, VoxelShape> FRIDGE_MIDDLE_OPEN = new HashMap<Direction, VoxelShape>(){{put(Direction.NORTH, Shapes.or(box(-0.5, 0, -10,1, 16, -9),box(1, 0, -12,3, 16, 3),box(1, 0, 3,15, 16, 16)));}};
    protected static final Map<Direction, VoxelShape> FRIDGE_BOTTOM_OPEN = new HashMap<Direction, VoxelShape>(){{put(Direction.NORTH, Shapes.or(box(-0.5, 2, -10, 1, 16, -9),box(1, 1, -12,3, 16, 3),box(1, 1, 3,15, 16, 16),box(1, 0, 2,15, 1, 16)));}};
    protected static final Map<Direction, VoxelShape> FRIDGE_OPEN = new HashMap<Direction, VoxelShape>(){{put(Direction.NORTH, Shapes.or(box(1, 1, -12,3, 16, 2),box(-0.5, 1, -10,1, 15, -9),box(2, 0, 1,15, 1, 2),box(1, -16, 2,15, 16, 16)));}};
