...
public class UnbakedClassicStoolModel implements UnbakedModel {
    public static final ResourceLocation[] CLASSIC_STOOL_PARTS_BASE = new ResourceLocation[] {
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/classic_stool/classic_stool"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/classic_stool/classic_stool_tucked")
    };

    public static final ResourceLocation STOOL_MODEL_ID = new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/classic_stool");
    public static final List<ResourceLocation> CLASSIC_STOOL_MODEL_IDS = new ArrayList<ResourceLocation>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){
                add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/" + variant.getSerializedName() + "_classic_stool"));
                if (variant.hasStripped())
                    add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.getSerializedName() + "_classic_stool"));
            }
