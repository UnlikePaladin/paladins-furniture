...
public record UnbakedClassicStoolModel(Variant variant) implements PFMUnbakedBlockStateModel {
    public static final MapCodec<UnbakedClassicStoolModel> MAP_CODEC = RecordCodecBuilder.mapCodec
            (instance ->
                    instance.group(Variant.MAP_CODEC.forGetter(UnbakedClassicStoolModel::variant))
    ...
    public BlockStateModel bake(ModelBaker baker){
        ...
        ModelRenderProperties itemSettings = ModelRenderProperties.fromResolvedModel(baker, baker.getModel(CLASSIC_STOOL_PARTS_BASE[0]), baker.getModel(CLASSIC_STOOL_PARTS_BASE[0]).getTopTextureSlots());
