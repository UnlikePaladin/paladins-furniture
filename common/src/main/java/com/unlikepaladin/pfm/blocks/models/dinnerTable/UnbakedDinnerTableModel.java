...
public record UnbakedDinnerTableModel(Variant variant) implements PFMUnbakedBlockStateModel {
    ...
    public static final Identifier[] DINNER_MODEL_PARTS_BASE = new Identifier[] {
            Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/dinner_table/dinner_table_middle"),
            Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/dinner_table/dinner_table_right"),
            Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/dinner_table/dinner_table_left"),
            Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/dinner_table/dinner_table_legs"),
            Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/dinner_table/dinner_table")
    };

    public static final Identifier TABLE_MODEL_ID = Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "block/dinner_table");
    public static final List<Identifier> TABLE_MODEL_IDS = new ArrayList<>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){
                add(Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "item/" + variant.getSerializedName() + "_table_dinner"));
                if (variant.hasStripped())
                    add(Identifier.fromNamespaceAndPath(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.getSerializedName() + "_table_dinner"));
            }
