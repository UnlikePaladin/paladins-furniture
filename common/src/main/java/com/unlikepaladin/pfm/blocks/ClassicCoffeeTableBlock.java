...
public class ClassicCoffeeTableBlock extends Block {
    ...
    public ClassicCoffeeTableBlock(BlockBehaviour.Properties settings) {
        ...
        if((material.equals(Material.WOOD) || material.equals(Material.NETHER_WOOD)) && this.getClass().isAssignableFrom(ClassicCoffeeTableBlock.class)){
    ...
    final static VoxelShape TABLE_CLASSIC_SOUTH_WEST_LEG = box(2, 0, 12, 4, 8, 14);
    final static VoxelShape TABLE_CLASSIC_SOUTH_EAST_LEG = box(12, 0, 12, 14, 8, 14);
