...
public class UnbakedKitchenWallDrawerModel implements UnbakedModel {
    public static final List<String> COUNTER_MODEL_PARTS_BASE = new ArrayList<>() {
        {
            add("block/kitchen_drawer/kitchen_drawer_middle");
            add("block/kitchen_drawer/kitchen_drawer_middle_inner_corner_left");
            add("block/kitchen_drawer/kitchen_drawer_middle_inner_corner_right");
            add("block/kitchen_drawer/kitchen_drawer_middle_outer_corner_left");
            add("block/kitchen_drawer/kitchen_drawer_middle_outer_corner_right");
            add("block/kitchen_drawer/kitchen_drawer_middle_open");
            add("block/kitchen_drawer/kitchen_drawer_middle_inner_corner_left");
            add("block/kitchen_drawer/kitchen_drawer_middle_inner_corner_right");
            add("block/kitchen_drawer/kitchen_drawer_middle_outer_corner_open_left");
            add("block/kitchen_drawer/kitchen_drawer_middle_outer_corner_open_right");
        }
    };
    ...
    public static final List<Identifier> DRAWER_MODEL_IDS = new ArrayList<>() {
        {
            for(WoodVariant variant : WoodVariant.values()){
                add(new Identifier(PaladinFurnitureMod.MOD_ID, "block/" + variant.asString() + "_kitchen_wall_drawer"));
            }
            for(WoodVariant variant : WoodVariant.values()){
                add(new Identifier(PaladinFurnitureMod.MOD_ID, "block/stripped_" + variant.asString() + "_kitchen_wall_drawer"));
            }
    ...
    private final List<String> MODEL_PARTS;
        ...
        public UnbakedKitchenWallDrawerModel(MaterialEnum variant, List<String> modelParts, BlockType type) {
    ...
    public static BakedModel getBakedModel(Sprite frame, ModelBakeSettings settings, Map<String,BakedModel> bakedModels, List<String> MODEL_PARTS) {
        return new BakedKitchenWallDrawerModel(frame, settings, bakedModels);
    }
}