...
public class UnbakedChairModernModel implements UnbakedModel {
    ...
    public static final ResourceLocation CHAIR_MODEL_ID = new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/chair_modern");
    public static final List<ResourceLocation> CHAIR_MODERN_MODEL_IDS = new ArrayList<ResourceLocation>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){

                add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/" + variant.getSerializedName() + "_chair_modern"));
                if (variant.hasStripped())
                    add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.getSerializedName() + "_chair_modern"));
            }
