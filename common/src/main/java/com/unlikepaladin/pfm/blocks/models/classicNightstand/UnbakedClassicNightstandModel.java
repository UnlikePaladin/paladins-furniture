...
public class UnbakedClassicNightstandModel implements UnbakedModel {
    public static final ResourceLocation[] NIGHTSTAND_MODEL_PARTS_BASE = new ResourceLocation[] {
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/classic_nightstand/classic_nightstand_middle"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/classic_nightstand/classic_nightstand_right"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/classic_nightstand/classic_nightstand_left"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/classic_nightstand/classic_nightstand"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/classic_nightstand/classic_nightstand_middle_open"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/classic_nightstand/classic_nightstand_right_open"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/classic_nightstand/classic_nightstand_left_open"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/classic_nightstand/classic_nightstand_open")
    };
    ...
    public static final List<ResourceLocation> NIGHSTAND_MODEL_IDS = new ArrayList<>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){
                ...
                add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/" + variant.getSerializedName() + "_classic_nightstand"));
                if (variant.hasStripped())
                    add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.getSerializedName() + "_classic_nightstand"));
            }
