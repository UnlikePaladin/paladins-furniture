...
public class UnbakedBedModel implements UnbakedModel {
    public static final List<String> SIMPLE_MODEL_PARTS_BASE = new ArrayList<String>() {
        {
    ...
    public static final List<Identifier> BED_MODEL_IDS = new ArrayList<Identifier>() {
        {
