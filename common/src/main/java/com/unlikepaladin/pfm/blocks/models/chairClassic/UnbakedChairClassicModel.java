...
public class UnbakedChairClassicModel implements UnbakedModel {
    public static final ResourceLocation[] CHAIR_CLASSIC_PARTS_BASE = new ResourceLocation[] {
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/chair_classic/chair_classic"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/chair_classic/chair_classic_tucked")
    };

    public static final ResourceLocation CHAIR_MODEL_ID = new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/chair_classic");
    public static final List<ResourceLocation> CHAIR_CLASSIC_MODEL_IDS = new ArrayList<ResourceLocation>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){

                add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/" + variant.getSerializedName() + "_chair_classic"));
                if (variant.hasStripped())
                    add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.getSerializedName() + "_chair_classic"));
            }
