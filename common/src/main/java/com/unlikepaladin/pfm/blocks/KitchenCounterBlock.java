...
public class KitchenCounterBlock extends HorizontalFacingBlock {
    ...
    public boolean canConnect(BlockView world, BlockPos pos, Direction direction)
    {
        ...
        return (isCounter(state) || state.getBlock() instanceof AbstractFurnaceBlock || state.getBlock() instanceof CauldronBlock) || isCookingForBlockHeadsBlock(state.getBlock().getTranslationKey());
    }
