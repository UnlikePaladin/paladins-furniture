...
public class BasicCoffeeTableBlock extends Block {
    ...
    public BasicCoffeeTableBlock(Properties settings) {
        ...
        if((material.equals(Material.WOOD) || material.equals(Material.NETHER_WOOD)) && this.getClass().isAssignableFrom(BasicCoffeeTableBlock.class)){
    ...
    final static VoxelShape TABLE_BASIC_NORTH_EAST_LEG = box(12, 0, 2, 14, 8, 4);
    final static VoxelShape TABLE_BASIC_SOUTH_WEST_LEG = box(2, 0, 12,4, 8, 14);
    final static VoxelShape TABLE_BASIC_NORTH_WEST_LEG = box(2, 0, 2,4, 8, 4);
    final static VoxelShape TABLE_BASIC_SOUTH_EAST_LEG = box(12, 0, 12,14, 8, 14);
