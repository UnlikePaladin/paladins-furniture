...
public class UnbakedKitchenSinkModel implements UnbakedModel {
    public static final ResourceLocation[] SINK_MODEL_PARTS_BASE = new ResourceLocation[] {
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_sink/kitchen_sink"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_sink/kitchen_sink_level1"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_sink/kitchen_sink_level2"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_sink/kitchen_sink_full"),
    };
    ...
    public static final List<ResourceLocation> SINK_MODEL_IDS = new ArrayList<>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){
                ...
                if (variant.hasStripped())
                    add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.getSerializedName() + "_kitchen_sink"));
            }
