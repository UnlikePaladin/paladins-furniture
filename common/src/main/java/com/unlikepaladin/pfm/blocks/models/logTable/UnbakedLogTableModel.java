...
public record UnbakedLogTableModel(Variant variant) implements PFMUnbakedBlockStateModel {
    public static final MapCodec<UnbakedLogTableModel> MAP_CODEC = RecordCodecBuilder.mapCodec
            (instance ->
                    instance.group(Variant.MAP_CODEC.forGetter(UnbakedLogTableModel::variant))
    ...
    public BlockStateModel bake(ModelBaker baker){
        ...
        ModelRenderProperties itemSettings = ModelRenderProperties.fromResolvedModel(baker, baker.getModel(LOG_MODEL_PARTS_BASE[0]), baker.getModel(LOG_MODEL_PARTS_BASE[0]).getTopTextureSlots());
