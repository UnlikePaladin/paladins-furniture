...
public record UnbakedModernDinnerTableModel(Variant variant) implements PFMUnbakedBlockStateModel {
    public static final MapCodec<UnbakedModernDinnerTableModel> MAP_CODEC = RecordCodecBuilder.mapCodec
            (instance ->
                    instance.group(Variant.MAP_CODEC.forGetter(UnbakedModernDinnerTableModel::variant))
    ...
    public BlockStateModel bake(ModelBaker baker){
        ...
        ModelRenderProperties itemSettings = ModelRenderProperties.fromResolvedModel(baker, baker.getModel(MODERN_DINNER_MODEL_PARTS_BASE[0]), baker.getModel(MODERN_DINNER_MODEL_PARTS_BASE[0]).getTopTextureSlots());
