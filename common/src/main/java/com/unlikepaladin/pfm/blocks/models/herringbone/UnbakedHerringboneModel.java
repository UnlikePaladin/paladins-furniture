...
public class UnbakedHerringboneModel implements UnbakedModel {
    ...
    private static final List<ResourceLocation> TEMPLATE_MODEL = List.of(new ResourceLocation("minecraft:block/cube_all"));
    ...
    public static final List<ResourceLocation> MODEL_IDS = new ArrayList<>() {
        {
            ...
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){
                add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/" + variant.getSerializedName() + "_herringbone_planks"));
                add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/" + variant.getSerializedName() + "_herringbone_planks"));
            }
        }
    };
    ...
    @Override
    public @Nullable BakedModel bake(ModelBaker loader, Function<Material, TextureAtlasSprite> textureGetter, ModelState rotationContainer, ResourceLocation modelId) {
