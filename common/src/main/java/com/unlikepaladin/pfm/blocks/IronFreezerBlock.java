...
public class IronFreezerBlock extends FreezerBlock {
    ...
    protected static final Map<Direction, VoxelShape> FREEZER = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(3, 13, -0.5,13, 14, 1),createCuboidShape(1, 1, 1,15, 16, 2),createCuboidShape(1, 0, 2,15, 32, 16)));}};
    protected static final Map<Direction, VoxelShape> FREEZER_SINGLE = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(3, 13, -0.5,13, 14, 1),createCuboidShape(1, 1, 1,15, 16, 2),createCuboidShape(1, 0, 2,15, 16, 16)));}};
    protected static final Map<Direction, VoxelShape> FREEZER_OPEN = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(3, 13, -3.5,13, 14, -2),createCuboidShape(1, 0, 2,15, 32, 16),createCuboidShape(1, 1, -2,15, 16, 3)));}};
    protected static final Map<Direction, VoxelShape> FREEZER_SINGLE_OPEN = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(3, 13, -3.5,13, 14, -2),createCuboidShape(1, 1, -2,15, 16, 3),createCuboidShape(1, 0, 3,15, 16, 16)));}};
