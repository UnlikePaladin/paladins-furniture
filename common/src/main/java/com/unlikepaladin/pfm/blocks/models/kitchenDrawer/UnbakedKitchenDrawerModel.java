...
public class UnbakedKitchenDrawerModel implements UnbakedModel {
    public static final List<String> COUNTER_MODEL_PARTS_BASE = new ArrayList<String>() {
        {
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_edge_left");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_edge_right");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_inner_corner_left");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_inner_corner_right");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_outer_corner_left");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_outer_corner_right");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_open");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_edge_left_open");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_edge_right_open");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_inner_corner_left");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_inner_corner_right");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_outer_corner_open_left");
            add("block/kitchen_drawer/template_kitchen_drawer/template_kitchen_drawer_outer_corner_open_right");
        }
    };

    private static final Identifier PARENT = new Identifier("block/block");
    public static final List<Identifier> DRAWER_MODEL_IDS = new ArrayList<Identifier>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){
                add(new Identifier(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/" + variant.asString() + "_kitchen_drawer"));
                if (variant.hasStripped())
                    add(new Identifier(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/stripped_" + variant.asString() + "_kitchen_drawer"));
            }
    ...
    public UnbakedKitchenDrawerModel(VariantBase<?> variant, List<String> modelParts, BlockType type) {
