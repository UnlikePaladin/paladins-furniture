...
public class UnbakedKitchenDrawerModel implements UnbakedModel {
    public static final ResourceLocation[] COUNTER_MODEL_PARTS_BASE = new ResourceLocation[] {
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_edge_left"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_edge_right"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_inner_corner_left"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_inner_corner_right"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_outer_corner_left"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_outer_corner_right"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_open"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_edge_left_open"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_edge_right_open"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_inner_corner_left"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_inner_corner_right"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_outer_corner_open_left"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer/kitchen_drawer_outer_corner_open_right")
    };

    private static final ResourceLocation PARENT = new ResourceLocation("block/block");
    public static final ResourceLocation DRAWER_MODEL_ID = new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/kitchen_drawer");
    public static final List<ResourceLocation> DRAWER_MODEL_IDS = new ArrayList<>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){
                add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/" + variant.getSerializedName() + "_kitchen_drawer"));
                if (variant.hasStripped())
                    add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.getSerializedName() + "_kitchen_drawer"));
            }
