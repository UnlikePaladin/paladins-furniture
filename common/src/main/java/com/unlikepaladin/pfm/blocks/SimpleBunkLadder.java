...
public class SimpleBunkLadder extends LadderBlock {
    ...
    public SimpleBunkLadder(Settings settings) {
        super(settings);
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        boolean up = ctx.getWorld().getBlockState(blockPos.up()).getBlock() instanceof SimpleBunkLadder;
    ...
    public BlockState getStateForNeighborUpdate(BlockState state, Direction direction, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
        if (direction.getAxis().isVertical() && canPlaceAt(state, world, pos)) {
            boolean up = world.getBlockState(pos.up()).getBlock() instanceof SimpleBunkLadder;
