...
public class UnbakedBasicDeskModel implements UnbakedModel {
    public static final ResourceLocation[] BASIC_MODEL_PARTS_BASE = new ResourceLocation[] {
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/basic_desk/basic_desk_base"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/basic_desk/basic_desk_north_west"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/basic_desk/basic_desk_north_east"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/basic_desk/basic_desk_south_west"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/basic_desk/basic_desk_south_east")
    };

    private static final ResourceLocation PARENT = new ResourceLocation("block/block");
    public static final ResourceLocation TABLE_MODEL_ID = new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/desk_basic");
    public static final List<ResourceLocation> MODEL_IDS = new ArrayList<ResourceLocation>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){
                add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/" + variant.getSerializedName() + "_desk_basic"));
                if (variant.hasStripped())
                    add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.getSerializedName() + "_desk_basic"));
            }
