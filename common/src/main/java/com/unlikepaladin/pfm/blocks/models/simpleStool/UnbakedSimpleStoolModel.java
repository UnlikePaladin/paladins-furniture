...
public record UnbakedSimpleStoolModel(Variant variant) implements PFMUnbakedBlockStateModel {
    public static final MapCodec<UnbakedSimpleStoolModel> MAP_CODEC = RecordCodecBuilder.mapCodec
            (instance ->
                    instance.group(Variant.MAP_CODEC.forGetter(UnbakedSimpleStoolModel::variant))
    ...
    public BlockStateModel bake(ModelBaker baker){
        ...
        ModelRenderProperties itemSettings = ModelRenderProperties.fromResolvedModel(baker, baker.getModel(SIMPLE_STOOL_PARTS_BASE[0]), baker.getModel(SIMPLE_STOOL_PARTS_BASE[0]).getTopTextureSlots());
