...
public class BakedKitchenCabinetModel implements BakedModel {
    protected final ModelBakeSettings settings;
    private final Sprite frame;
    private final Map<String,BakedModel> bakedModels;
    public BakedKitchenCabinetModel(Sprite frame, ModelBakeSettings settings, Map<String, BakedModel> bakedModels) {
        this.frame = frame;
