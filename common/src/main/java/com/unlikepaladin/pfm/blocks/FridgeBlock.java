...
public class FridgeBlock extends HorizontalFacingBlockWithEntity {
    ...
    protected static final Map<Direction, VoxelShape> FRIDGE_SINGLE = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(12, 3, -0.5,13, 14, 1), createCuboidShape(1, 1, 1,15, 16, 2), createCuboidShape(1, 0, 2,15, 16, 16)));}};
    ...
    protected static final Map<Direction, VoxelShape> FRIDGE_BOTTOM = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(12, 4, -0.5,13, 16, 1), createCuboidShape(1, 1, 1,15, 16, 2), createCuboidShape(1, 0, 2,15, 16, 16)));}};
    protected static final Map<Direction, VoxelShape> FRIDGE = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(12, 4, -0.5, 13, 20, 1), createCuboidShape(1, 1, 1,15, 21, 2),createCuboidShape(1, 0, 2,15, 32, 16)));}};
    protected static final Map<Direction, VoxelShape> FRIDGE_MIDDLE_FREEZER = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(12, 0, -0.5,13, 20, 1),createCuboidShape(1, 0, 1,15, 21, 16),createCuboidShape(1, 21, 2,15, 32, 16)));}};

    protected static final Map<Direction, VoxelShape> FRIDGE_SINGLE_OPEN = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(-0.5, 3, -10,1, 14, -9), createCuboidShape(1, 1, -12,3, 16, 2),createCuboidShape(1, 0, 2,15, 16, 16)));}};
    protected static final Map<Direction, VoxelShape> FRIDGE_TOP_OPEN = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(-0.5, 0, -10,1, 15, -9), createCuboidShape(1, 0, -12,3, 16, 2),createCuboidShape(1, 0, 2,15, 16, 16)));}};
    protected static final Map<Direction, VoxelShape> FRIDGE_MIDDLE_OPEN = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(-0.5, 0, -10,1, 16, -9),createCuboidShape(1, 0, -12,3, 16, 2),createCuboidShape(1, 0, 2,15, 16, 16)));}};
    protected static final Map<Direction, VoxelShape> FRIDGE_BOTTOM_OPEN = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(-0.5, 4, -10,1, 16, -9),createCuboidShape(1, 1, -12,3, 16, 2),createCuboidShape(1, 0, 3,15, 16, 16),createCuboidShape(1, 1, 2,15, 16, 3)));}};
    protected static final Map<Direction, VoxelShape> FRIDGE_OPEN = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(-0.5, 4, -10,1, 20, -9),createCuboidShape(1, 1, -12,3, 20, 2),createCuboidShape(1, 20, 1,15, 21, 2),createCuboidShape(1, 0, 2,15, 32, 16)));}};
    protected static final Map<Direction, VoxelShape> FRIDGE_MIDDLE_FREEZER_OPEN = new HashMap<Direction, VoxelShape>() {{put(Direction.NORTH, VoxelShapes.union(createCuboidShape(-0.5, 0, -10,1, 20, -9),createCuboidShape(1, 0, -12,3, 20, 2),createCuboidShape(1, 0, 2,15, 32, 16),createCuboidShape(1, 20, 1,15, 21, 2)));}};
