...
public class UnbakedChairDinnerModel implements UnbakedModel {
    public static final ResourceLocation[] CHAIR_DINNER_PARTS_BASE = new ResourceLocation[] {
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/chair_dinner/chair_dinner"),
            new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/chair_dinner/chair_dinner_tucked")
    };

    public static final ResourceLocation CHAIR_MODEL_ID = new ResourceLocation(PaladinFurnitureMod.MOD_ID, "block/chair_dinner");
    public static final List<ResourceLocation> CHAIR_DINNER_MODEL_IDS = new ArrayList<ResourceLocation>() {
        {
            for(WoodVariant variant : WoodVariantRegistry.getVariants()){

                add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/" + variant.getSerializedName() + "_chair_dinner"));
                if (variant.hasStripped())
                    add(new ResourceLocation(PaladinFurnitureMod.MOD_ID, "item/stripped_" + variant.getSerializedName() + "_chair_dinner"));
            }
