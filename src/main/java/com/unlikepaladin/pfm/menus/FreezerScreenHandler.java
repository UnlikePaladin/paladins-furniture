...
public class FreezerScreenHandler
    ...
    public FreezerScreenHandler(int syncId, PlayerInventory playerInventory) {
        super(PaladinFurnitureMod.FREEZER_SCREEN_HANDLER, RecipeType.SMELTING, RecipeBookCategory.FURNACE, syncId, playerInventory);
    }
    ...
    public FreezerScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
        super(PaladinFurnitureMod.FREEZER_SCREEN_HANDLER, RecipeType.SMELTING, RecipeBookCategory.FURNACE, syncId, playerInventory, inventory, propertyDelegate);
    }
