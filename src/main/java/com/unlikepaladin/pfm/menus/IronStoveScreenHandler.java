...
public class IronStoveScreenHandler extends AbstractFurnaceScreenHandler {
    public IronStoveScreenHandler(int i, PlayerInventory playerInventory) {
        super(ScreenHandlersRegistry.IRON_STOVE_SCREEN_HANDLER, RecipeType.SMOKING, RecipeBookCategory.SMOKER, i, playerInventory);
    }
    ...
    public IronStoveScreenHandler(int i, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
        super(ScreenHandlersRegistry.IRON_STOVE_SCREEN_HANDLER, RecipeType.SMOKING, RecipeBookCategory.SMOKER, i, playerInventory, inventory, propertyDelegate);
    }
}