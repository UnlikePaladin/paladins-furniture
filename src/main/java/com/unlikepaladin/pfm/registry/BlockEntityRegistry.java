...
public class BlockEntityRegistry {
    ...
    public static void registerBlockEntities() {
        ...
        STOVE_BLOCK_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, MOD_ID + ":stove_block_entity", FabricBlockEntityTypeBuilder.create(StoveBlockEntity::new, BlockItemRegistry.WHITE_STOVE, BlockItemRegistry.IRON_STOVE).build(null));
