...
public class BlockItemRegistry {
    ...
    public static final Block MANGROVE_CHAIR = new BasicChair(FabricBlockSettings.copyOf(OAK_CHAIR).mapColor(MapColor.RED));
    ...
    public static final Block STRIPPED_MANGROVE_CHAIR_DINNER = new DinnerChair(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block MANGROVE_CHAIR_CLASSIC = new ClassicChair(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block STRIPPED_MANGROVE_CHAIR_CLASSIC = new ClassicChair(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block MANGROVE_CHAIR_MODERN = new ModernChair(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    //Arm Chairs
    public static final Block WHITE_ARM_CHAIR= new ArmChairColored(DyeColor.WHITE, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block BLUE_ARM_CHAIR= new ArmChairColored(DyeColor.BLUE, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block GREEN_ARM_CHAIR= new ArmChairColored(DyeColor.GREEN, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block GRAY_ARM_CHAIR= new ArmChairColored(DyeColor.GRAY, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block PINK_ARM_CHAIR= new ArmChairColored(DyeColor.PINK, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block BROWN_ARM_CHAIR= new ArmChairColored(DyeColor.BROWN, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block ORANGE_ARM_CHAIR= new ArmChairColored(DyeColor.ORANGE, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block YELLOW_ARM_CHAIR= new ArmChairColored(DyeColor.YELLOW, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block PURPLE_ARM_CHAIR= new ArmChairColored(DyeColor.PURPLE, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block CYAN_ARM_CHAIR= new ArmChairColored(DyeColor.CYAN, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block LIME_ARM_CHAIR= new ArmChairColored(DyeColor.LIME, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block MAGENTA_ARM_CHAIR= new ArmChairColored(DyeColor.MAGENTA, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block LIGHT_BLUE_ARM_CHAIR= new ArmChairColored(DyeColor.LIGHT_BLUE, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block LIGHT_GRAY_ARM_CHAIR= new ArmChairColored(DyeColor.LIGHT_GRAY, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block RED_ARM_CHAIR= new ArmChairColored(DyeColor.RED, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block BLACK_ARM_CHAIR= new ArmChairColored(DyeColor.BLACK, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    ...
    public static final Block WHITE_SIMPLE_SOFA= new SimpleSofa(DyeColor.WHITE, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block BLUE_SIMPLE_SOFA= new SimpleSofa(DyeColor.BLUE, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block GREEN_SIMPLE_SOFA= new SimpleSofa(DyeColor.GREEN, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block GRAY_SIMPLE_SOFA= new SimpleSofa(DyeColor.GRAY, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block PINK_SIMPLE_SOFA= new SimpleSofa(DyeColor.PINK, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block BROWN_SIMPLE_SOFA= new SimpleSofa(DyeColor.BROWN, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block ORANGE_SIMPLE_SOFA= new SimpleSofa(DyeColor.ORANGE, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block YELLOW_SIMPLE_SOFA= new SimpleSofa(DyeColor.YELLOW, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block PURPLE_SIMPLE_SOFA= new SimpleSofa(DyeColor.PURPLE, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block CYAN_SIMPLE_SOFA= new SimpleSofa(DyeColor.CYAN, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block LIME_SIMPLE_SOFA= new SimpleSofa(DyeColor.LIME, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block MAGENTA_SIMPLE_SOFA= new SimpleSofa(DyeColor.MAGENTA, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block LIGHT_BLUE_SIMPLE_SOFA= new SimpleSofa(DyeColor.LIGHT_BLUE, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block LIGHT_GRAY_SIMPLE_SOFA= new SimpleSofa(DyeColor.LIGHT_GRAY, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block RED_SIMPLE_SOFA= new SimpleSofa(DyeColor.RED, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    public static final Block BLACK_SIMPLE_SOFA= new SimpleSofa(DyeColor.BLACK, FabricBlockSettings.of(Material.WOOL).strength(2.0f).resistance(2.0f).nonOpaque().sounds(BlockSoundGroup.WOOL));
    ...
    public static final Block MANGROVE_BASIC_TABLE = new BasicTable(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block MANGROVE_CLASSIC_TABLE = new ClassicTable(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block MANGROVE_LOG_TABLE = new LogTable(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block MANGROVE_RAW_LOG_TABLE = new LogTable(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block STRIPPED_MANGROVE_RAW_LOG_TABLE = new LogTable(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block MANGROVE_MODERN_DINNER_TABLE = new ModernDinnerTable(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block MANGROVE_LOG_STOOL = new LogStool(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block MANGROVE_SIMPLE_STOOL = new SimpleStool(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block MANGROVE_MODERN_STOOL = new ModernStool(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block MANGROVE_CLASSIC_STOOL = new ClassicStool(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block JUNGLE_KITCHEN_CABINET = new KitchenCabinet(FabricBlockSettings.copyOf(JUNGLE_KITCHEN_COUNTER));
    public static final Block JUNGLE_KITCHEN_SINK = new KitchenSink(FabricBlockSettings.copyOf(JUNGLE_KITCHEN_COUNTER),  LeveledCauldronBlock.RAIN_PREDICATE, SinkBehavior.WATER_SINK_BEHAVIOR);
    ...
    public static final Block MANGROVE_KITCHEN_COUNTER = new KitchenCounter(FabricBlockSettings.copyOf(OAK_KITCHEN_COUNTER).mapColor(MapColor.RED));
    public static final Block MANGROVE_KITCHEN_DRAWER = new KitchenDrawer(FabricBlockSettings.copyOf(MANGROVE_KITCHEN_COUNTER));
    public static final Block MANGROVE_KITCHEN_CABINET = new KitchenCabinet(FabricBlockSettings.copyOf(MANGROVE_KITCHEN_COUNTER));
    public static final Block MANGROVE_KITCHEN_SINK = new KitchenSink(FabricBlockSettings.copyOf(MANGROVE_KITCHEN_COUNTER),  LeveledCauldronBlock.RAIN_PREDICATE, SinkBehavior.WATER_SINK_BEHAVIOR);
    ...
    public static final Block STRIPPED_MANGROVE_KITCHEN_COUNTER = new KitchenCounter(FabricBlockSettings.copyOf(MANGROVE_KITCHEN_COUNTER));
    public static final Block STRIPPED_MANGROVE_KITCHEN_DRAWER = new KitchenDrawer(FabricBlockSettings.copyOf(MANGROVE_KITCHEN_COUNTER));
    public static final Block STRIPPED_MANGROVE_KITCHEN_CABINET = new KitchenCabinet(FabricBlockSettings.copyOf(MANGROVE_KITCHEN_COUNTER));
    public static final Block STRIPPED_MANGROVE_KITCHEN_SINK = new KitchenSink(FabricBlockSettings.copyOf(MANGROVE_KITCHEN_COUNTER),  LeveledCauldronBlock.RAIN_PREDICATE, SinkBehavior.WATER_SINK_BEHAVIOR);
    ...
    public static final Block MANGROVE_CLASSIC_NIGHTSTAND = new ClassicNightstand(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block STRIPPED_MANGROVE_CLASSIC_NIGHTSTAND = new ClassicNightstand(FabricBlockSettings.copyOf(MANGROVE_CHAIR));
    ...
    public static final Block MANGROVE_RED_SIMPLE_BED = new SimpleBed(DyeColor.RED, FabricBlockSettings.copyOf(Blocks.RED_BED));
    public static final Block MANGROVE_ORANGE_SIMPLE_BED = new SimpleBed(DyeColor.ORANGE, FabricBlockSettings.copyOf(Blocks.ORANGE_BED));
    public static final Block MANGROVE_YELLOW_SIMPLE_BED = new SimpleBed(DyeColor.YELLOW, FabricBlockSettings.copyOf(Blocks.YELLOW_BED));
    public static final Block MANGROVE_GREEN_SIMPLE_BED = new SimpleBed(DyeColor.GREEN, FabricBlockSettings.copyOf(Blocks.GREEN_BED));
    public static final Block MANGROVE_LIME_SIMPLE_BED = new SimpleBed(DyeColor.LIME, FabricBlockSettings.copyOf(Blocks.LIME_BED));
    public static final Block MANGROVE_CYAN_SIMPLE_BED = new SimpleBed(DyeColor.CYAN, FabricBlockSettings.copyOf(Blocks.CYAN_BED));
    public static final Block MANGROVE_BLUE_SIMPLE_BED = new SimpleBed(DyeColor.BLUE, FabricBlockSettings.copyOf(Blocks.BLUE_BED));
    public static final Block MANGROVE_LIGHT_BLUE_SIMPLE_BED = new SimpleBed(DyeColor.LIGHT_BLUE, FabricBlockSettings.copyOf(Blocks.LIGHT_BLUE_BED));
    public static final Block MANGROVE_LIGHT_GRAY_SIMPLE_BED = new SimpleBed(DyeColor.LIGHT_GRAY, FabricBlockSettings.copyOf(Blocks.LIGHT_GRAY_BED));
    public static final Block MANGROVE_MAGENTA_SIMPLE_BED = new SimpleBed(DyeColor.MAGENTA, FabricBlockSettings.copyOf(Blocks.MAGENTA_BED));
    public static final Block MANGROVE_PINK_SIMPLE_BED = new SimpleBed(DyeColor.PINK, FabricBlockSettings.copyOf(Blocks.PINK_BED));
    public static final Block MANGROVE_PURPLE_SIMPLE_BED = new SimpleBed(DyeColor.PURPLE, FabricBlockSettings.copyOf(Blocks.PURPLE_BED));
    public static final Block MANGROVE_WHITE_SIMPLE_BED = new SimpleBed(DyeColor.WHITE, FabricBlockSettings.copyOf(Blocks.WHITE_BED));
    public static final Block MANGROVE_BROWN_SIMPLE_BED = new SimpleBed(DyeColor.BROWN, FabricBlockSettings.copyOf(Blocks.BROWN_BED));
    public static final Block MANGROVE_GRAY_SIMPLE_BED = new SimpleBed(DyeColor.GRAY, FabricBlockSettings.copyOf(Blocks.GRAY_BED));
    public static final Block MANGROVE_BLACK_SIMPLE_BED = new SimpleBed(DyeColor.BLACK, FabricBlockSettings.copyOf(Blocks.BLACK_BED));
    ...
    public static final Block MANGROVE_RED_CLASSIC_BED = new ClassicBed(DyeColor.RED, FabricBlockSettings.copyOf(Blocks.RED_BED));
    public static final Block MANGROVE_ORANGE_CLASSIC_BED = new ClassicBed(DyeColor.ORANGE, FabricBlockSettings.copyOf(Blocks.ORANGE_BED));
    public static final Block MANGROVE_YELLOW_CLASSIC_BED = new ClassicBed(DyeColor.YELLOW, FabricBlockSettings.copyOf(Blocks.YELLOW_BED));
    public static final Block MANGROVE_GREEN_CLASSIC_BED = new ClassicBed(DyeColor.GREEN, FabricBlockSettings.copyOf(Blocks.GREEN_BED));
    public static final Block MANGROVE_LIME_CLASSIC_BED = new ClassicBed(DyeColor.LIME, FabricBlockSettings.copyOf(Blocks.LIME_BED));
    public static final Block MANGROVE_CYAN_CLASSIC_BED = new ClassicBed(DyeColor.CYAN, FabricBlockSettings.copyOf(Blocks.CYAN_BED));
    public static final Block MANGROVE_BLUE_CLASSIC_BED = new ClassicBed(DyeColor.BLUE, FabricBlockSettings.copyOf(Blocks.BLUE_BED));
    public static final Block MANGROVE_LIGHT_BLUE_CLASSIC_BED = new ClassicBed(DyeColor.LIGHT_BLUE, FabricBlockSettings.copyOf(Blocks.LIGHT_BLUE_BED));
    public static final Block MANGROVE_LIGHT_GRAY_CLASSIC_BED = new ClassicBed(DyeColor.LIGHT_GRAY, FabricBlockSettings.copyOf(Blocks.LIGHT_GRAY_BED));
    public static final Block MANGROVE_MAGENTA_CLASSIC_BED = new ClassicBed(DyeColor.MAGENTA, FabricBlockSettings.copyOf(Blocks.MAGENTA_BED));
    public static final Block MANGROVE_PINK_CLASSIC_BED = new ClassicBed(DyeColor.PINK, FabricBlockSettings.copyOf(Blocks.PINK_BED));
    public static final Block MANGROVE_PURPLE_CLASSIC_BED = new ClassicBed(DyeColor.PURPLE, FabricBlockSettings.copyOf(Blocks.PURPLE_BED));
    public static final Block MANGROVE_WHITE_CLASSIC_BED = new ClassicBed(DyeColor.WHITE, FabricBlockSettings.copyOf(Blocks.WHITE_BED));
    public static final Block MANGROVE_BROWN_CLASSIC_BED = new ClassicBed(DyeColor.BROWN, FabricBlockSettings.copyOf(Blocks.BROWN_BED));
    public static final Block MANGROVE_GRAY_CLASSIC_BED = new ClassicBed(DyeColor.GRAY, FabricBlockSettings.copyOf(Blocks.GRAY_BED));
    public static final Block MANGROVE_BLACK_CLASSIC_BED = new ClassicBed(DyeColor.BLACK, FabricBlockSettings.copyOf(Blocks.BLACK_BED));
    ...
    public static void registerBlocks(){
        ...
        //Armchairs
        registerFurniture("white_simple_sofa", WHITE_SIMPLE_SOFA, true);
        registerFurniture("orange_simple_sofa", ORANGE_SIMPLE_SOFA, true);
        registerFurniture("magenta_simple_sofa", MAGENTA_SIMPLE_SOFA, true);
        registerFurniture("light_blue_simple_sofa", LIGHT_BLUE_SIMPLE_SOFA, true);
        registerFurniture("yellow_simple_sofa", YELLOW_SIMPLE_SOFA, true);
        registerFurniture("lime_simple_sofa", LIME_SIMPLE_SOFA, true);
        registerFurniture("pink_simple_sofa", PINK_SIMPLE_SOFA, true);
        registerFurniture("gray_simple_sofa", GRAY_SIMPLE_SOFA, true);
        registerFurniture("light_gray_simple_sofa", LIGHT_GRAY_SIMPLE_SOFA, true);
        registerFurniture("cyan_simple_sofa", CYAN_SIMPLE_SOFA, true);
        registerFurniture("purple_simple_sofa", PURPLE_SIMPLE_SOFA, true);
        registerFurniture("blue_simple_sofa", BLUE_SIMPLE_SOFA, true);
        registerFurniture("brown_simple_sofa", BROWN_SIMPLE_SOFA, true);
        registerFurniture("green_simple_sofa", GREEN_SIMPLE_SOFA, true);
        registerFurniture("red_simple_sofa", RED_SIMPLE_SOFA, true);
        registerFurniture("black_simple_sofa", BLACK_SIMPLE_SOFA, true);

        registerFurniture("arm_chair_leather", ARM_CHAIR_LEATHER, true);

        registerFurniture("white_arm_chair", WHITE_ARM_CHAIR, true);
        registerFurniture("orange_arm_chair", ORANGE_ARM_CHAIR, true);
        registerFurniture("magenta_arm_chair", MAGENTA_ARM_CHAIR, true);
        registerFurniture("light_blue_arm_chair", LIGHT_BLUE_ARM_CHAIR, true);
        registerFurniture("yellow_arm_chair", YELLOW_ARM_CHAIR, true);
        registerFurniture("lime_arm_chair", LIME_ARM_CHAIR, true);
        registerFurniture("pink_arm_chair", PINK_ARM_CHAIR, true);
        registerFurniture("gray_arm_chair", GRAY_ARM_CHAIR, true);
        registerFurniture("light_gray_arm_chair", LIGHT_GRAY_ARM_CHAIR, true);
        registerFurniture("cyan_arm_chair", CYAN_ARM_CHAIR, true);
        registerFurniture("purple_arm_chair", PURPLE_ARM_CHAIR, true);
        registerFurniture("blue_arm_chair", BLUE_ARM_CHAIR, true);
        registerFurniture("brown_arm_chair", BROWN_ARM_CHAIR, true);
        registerFurniture("green_arm_chair", GREEN_ARM_CHAIR, true);
        registerFurniture("red_arm_chair", RED_ARM_CHAIR, true);
        registerFurniture("black_arm_chair", BLACK_ARM_CHAIR, true);
        ...
        registerFurniture("mangrove_table_modern_dinner", MANGROVE_MODERN_DINNER_TABLE, true);
        ...
        registerFurniture("stripped_mangrove_table_modern_dinner", STRIPPED_MANGROVE_MODERN_DINNER_TABLE, true);
        ...
        registerFurniture("mangrove_classic_nightstand", MANGROVE_CLASSIC_NIGHTSTAND, true);
        ...
        registerFurniture("stripped_mangrove_classic_nightstand", STRIPPED_MANGROVE_CLASSIC_NIGHTSTAND, true);
        ...
        registerFurniture("mangrove_red_simple_bed", MANGROVE_RED_SIMPLE_BED, 1);
        registerFurniture("mangrove_orange_simple_bed", MANGROVE_ORANGE_SIMPLE_BED, 1);
        registerFurniture("mangrove_yellow_simple_bed", MANGROVE_YELLOW_SIMPLE_BED, 1);
        registerFurniture("mangrove_green_simple_bed", MANGROVE_GREEN_SIMPLE_BED, 1);
        registerFurniture("mangrove_lime_simple_bed", MANGROVE_LIME_SIMPLE_BED, 1);
        registerFurniture("mangrove_blue_simple_bed", MANGROVE_BLUE_SIMPLE_BED, 1);
        registerFurniture("mangrove_cyan_simple_bed", MANGROVE_CYAN_SIMPLE_BED, 1);
        registerFurniture("mangrove_light_blue_simple_bed", MANGROVE_LIGHT_BLUE_SIMPLE_BED, 1);
        registerFurniture("mangrove_light_gray_simple_bed", MANGROVE_LIGHT_GRAY_SIMPLE_BED, 1);
        registerFurniture("mangrove_purple_simple_bed", MANGROVE_PURPLE_SIMPLE_BED, 1);
        registerFurniture("mangrove_magenta_simple_bed", MANGROVE_MAGENTA_SIMPLE_BED, 1);
        registerFurniture("mangrove_pink_simple_bed", MANGROVE_PINK_SIMPLE_BED, 1);
        registerFurniture("mangrove_brown_simple_bed", MANGROVE_BROWN_SIMPLE_BED, 1);
        registerFurniture("mangrove_gray_simple_bed", MANGROVE_GRAY_SIMPLE_BED, 1);
        registerFurniture("mangrove_black_simple_bed", MANGROVE_BLACK_SIMPLE_BED, 1);
        registerFurniture("mangrove_white_simple_bed", MANGROVE_WHITE_SIMPLE_BED, 1);
        ...
        registerFurniture("mangrove_red_classic_bed", MANGROVE_RED_CLASSIC_BED, 1);
        registerFurniture("mangrove_orange_classic_bed", MANGROVE_ORANGE_CLASSIC_BED, 1);
        registerFurniture("mangrove_yellow_classic_bed", MANGROVE_YELLOW_CLASSIC_BED, 1);
        registerFurniture("mangrove_green_classic_bed", MANGROVE_GREEN_CLASSIC_BED, 1);
        registerFurniture("mangrove_lime_classic_bed", MANGROVE_LIME_CLASSIC_BED, 1);
        registerFurniture("mangrove_blue_classic_bed", MANGROVE_BLUE_CLASSIC_BED, 1);
        registerFurniture("mangrove_cyan_classic_bed", MANGROVE_CYAN_CLASSIC_BED, 1);
        registerFurniture("mangrove_light_blue_classic_bed", MANGROVE_LIGHT_BLUE_CLASSIC_BED, 1);
        registerFurniture("mangrove_light_gray_classic_bed", MANGROVE_LIGHT_GRAY_CLASSIC_BED, 1);
        registerFurniture("mangrove_purple_classic_bed", MANGROVE_PURPLE_CLASSIC_BED, 1);
        registerFurniture("mangrove_magenta_classic_bed", MANGROVE_MAGENTA_CLASSIC_BED, 1);
        registerFurniture("mangrove_pink_classic_bed", MANGROVE_PINK_CLASSIC_BED, 1);
        registerFurniture("mangrove_brown_classic_bed", MANGROVE_BROWN_CLASSIC_BED, 1);
        registerFurniture("mangrove_gray_classic_bed", MANGROVE_GRAY_CLASSIC_BED, 1);
        registerFurniture("mangrove_black_classic_bed", MANGROVE_BLACK_CLASSIC_BED, 1);
        registerFurniture("mangrove_white_classic_bed", MANGROVE_WHITE_CLASSIC_BED, 1);
