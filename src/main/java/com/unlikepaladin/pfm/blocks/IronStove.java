...
public class IronStove extends Stove {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView view, BlockPos pos, ShapeContext context) {
        ...
        switch(dir) {
            case WEST:
                return rotateShape(Direction.NORTH, Direction.EAST, IRON_STOVE);
            case NORTH:
                return rotateShape(Direction.NORTH, Direction.SOUTH, IRON_STOVE);
            case SOUTH:
                return IRON_STOVE;
            case EAST:
            default:
                return rotateShape(Direction.NORTH, Direction.WEST, IRON_STOVE);
