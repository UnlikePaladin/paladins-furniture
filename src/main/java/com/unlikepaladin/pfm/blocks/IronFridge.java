...
public class IronFridge extends Fridge{
    ...
    public IronFridge(Settings settings, Supplier<Block> freezer) {
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        return (world.getBlockState(pos.up()).isAir()) || (world.getBlockState(pos.down()).getBlock() instanceof Freezer);
    }
    @Override
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        world.setBlockState(pos, this.freezer.get().getDefaultState().with(FACING, placer.getHorizontalFacing()), Block.NOTIFY_ALL);
        world.setBlockState(pos.up(), this.getDefaultState().with(FACING, placer.getHorizontalFacing()), Block.NOTIFY_ALL);
