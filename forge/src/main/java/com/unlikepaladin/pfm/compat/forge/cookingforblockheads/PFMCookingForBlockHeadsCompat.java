package com.unlikepaladin.pfm.compat.forge.cookingforblockheads;
...
import com.unlikepaladin.pfm.compat.forge.cookingforblockheads.menu.StoveBlockEntityRendererBalm;
import com.unlikepaladin.pfm.compat.forge.cookingforblockheads.menu.StoveMenuBalm;
import com.unlikepaladin.pfm.compat.forge.cookingforblockheads.menu.StoveScreenBalm;
...
public class PFMCookingForBlockHeadsCompat {
    ...
    public static <T extends ScreenHandler> TriFunc<Integer, PlayerInventory, PacketByteBuf, T> getStoveScreenHandler() {
        return (integer, playerInventory, packetByteBuf) -> {
            ...
            return (T) new StoveMenuBalm(integer, playerInventory, (StoveBlockEntityBalm)blockEntity);
        };
    }
    ...
    public static <T extends ScreenHandler, J extends Screen & ScreenHandlerProvider<T>> TriFunc<T, PlayerInventory, Text,J> getStoveScreen() {
        return (t, playerInventory, text) -> (J) new StoveScreenBalm((StoveMenuBalm) t, playerInventory, text);
    }
