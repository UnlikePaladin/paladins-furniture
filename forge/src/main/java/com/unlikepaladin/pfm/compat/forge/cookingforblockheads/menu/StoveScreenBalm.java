...
public class StoveScreenBalm extends HandledScreen<StoveMenuBalm> {
    private static final Identifier texture = new Identifier("cookingforblockheads", "textures/gui/oven.png");

    public StoveScreenBalm(StoveMenuBalm container, PlayerInventory playerInventory, Text displayName) {
