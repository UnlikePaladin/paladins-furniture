...
public class GenericStorageBlockEntityBalm3x3 extends GenericStorageBlockEntity3x3 {
    ...
    public GenericStorageBlockEntityBalm3x3() {
        super();
        this.inventoryHandler = new InventoryHandler(this.inventory) {
            @Override
            protected void onContentsChanged(int slot) {
                GenericStorageBlockEntityBalm3x3.this.setChanged();
