...
public class BlockItemRegistryForge {
    ...
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, PaladinFurnitureMod.MOD_ID);
    static {
...
/*        Set<BlockState> originalBedStates = PointOfInterestType.HOME.getBlockStates();
    ...
    //@SubscribeEvent
    static {
        PaladinFurnitureModBlocksItems.FURNITURE_BOOK = registerItem("furniture_book", new FurnitureGuideBookImpl(new Item.Settings().group(PaladinFurnitureMod.FURNITURE_GROUP).rarity(Rarity.RARE).maxCount(1)));
        PaladinFurnitureModBlocksItems.LIGHT_SWITCH_ITEM = (BlockItem) registerItem("light_switch", new LightSwitchItem(PaladinFurnitureModBlocksItems.LIGHT_SWITCH, new Item.Settings().group(PaladinFurnitureMod.FURNITURE_GROUP)));
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, PaladinFurnitureMod.MOD_ID);
    ...
    public static Block registerBlock(String blockName, Block block, boolean registerItem) {
        ...
        RegistryObject<Block> tempBlock = BLOCKS.register(blockName, () -> block);
        registerBlockItem(blockName, tempBlock.get());
        return tempBlock.get();
    }

    public static Item registerItem(String itemName, Item item) {
        return ITEMS.register(itemName, () -> item).get();
    }
