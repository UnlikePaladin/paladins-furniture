...
public class BlockEntityRegistryForge {
    ...
    public static void registerBlockEntities(RegisterEvent event){
        ...
        event.register(ForgeRegistries.Keys.BLOCK_ENTITY_TYPES, blockEntityTypeRegisterHelper -> {
            ...
            blockEntityTypeRegisterHelper.register(new Identifier(PaladinFurnitureMod.MOD_ID, "trashcan_block_entity"),BlockEntities.TRASHCAN_BLOCK_ENTITY = BlockEntityType.Builder.create(TrashcanBlockEntityImpl::new, PaladinFurnitureModBlocksItems.MESH_TRASHCAN, PaladinFurnitureModBlocksItems.TRASHCAN).build(null));
