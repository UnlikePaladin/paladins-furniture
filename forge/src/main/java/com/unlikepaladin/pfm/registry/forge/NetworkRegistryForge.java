...
public class NetworkRegistryForge {
    ...
    public static void registerPackets() {
        int id = 0;
        PFM_SERVER_CHANNEL.registerMessage(++id, MicrowaveUpdatePacket.class, MicrowaveUpdatePacket::encode, MicrowaveUpdatePacket::decode, MicrowaveUpdatePacket::handle);
    }
